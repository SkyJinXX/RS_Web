	...
	window.Zepto = Zepto, "$" in window || (window.$ = Zepto),
		...
		function() {
			...
			function P(e) {
				...
				return t.selectNode(document.body), t.createContextualFragment(e.responseText)
			}
			...
			function ot(e, t) {
				var n;
				return arguments.length < 2 && (t = .45), arguments.length ? n = t / (2 * o) * Math.asin(1 / e) : (e = 1, n = t / 4),
					function(r) {
						return 1 + e * Math.pow(2, 10 * -r) * Math.sin((r - n) * 2 * o / t)
					}
			}
			...
			function ht(e) {
				var t = [e.a, e.b],
					...
					i = pt(t, n),
					s = dt(vt(n, t, -i)) || 0;
				t[0] * n[1] < n[0] * t[1] && (t[0] *= -1, t[1] *= -1, r *= -1, i *= -1), this.rotate = (r ? Math.atan2(t[1], t[0]) : Math.atan2(-n[0], n[1])) * f, this.translate = [e.e, e.f], this.scale = [r, s], this.skew = s ? Math.atan2(i, s) * f : 0
			}
			...
			function Ct(e, t, n) {
				...
				if(o) {
					...
					switch(o[1]) {
						...
						case "rgb":
							return t(Ot(u[0]), Ot(u[1]), Ot(u[2]))
					}
				}
				return(a = Mt.get(e)) ? t(a.r, a.g, a.b) : (e != null && e.charAt(0) === "#" && (e.length === 4 ? (r = e.charAt(1), r += r, i = e.charAt(2), i += i, s = e.charAt(3), s += s) : e.length === 7 && (r = e.substring(1, 3), i = e.substring(3, 5), s = e.substring(5, 7)), r = parseInt(r, 16), i = parseInt(i, 16), s = parseInt(s, 16)), t(r, i, s))
			}
			...
			function kt(e, t, n) {
				var r = Math.min(e /= 255, t /= 255, n /= 255),
					...
					s = i - r,
					o, u, a = (i + r) / 2;
				return s ? (u = a < .5 ? s / (i + r) : s / (2 - i - r), e == i ? o = (t - n) / s + (t < n ? 6 : 0) : t == i ? o = (n - e) / s + 2 : o = (e - t) / s + 4, o *= 60) : u = o = 0, _t(o, u, a)
			}

			function Lt(e, t, n) {
				e = At(e), t = At(t), n = At(n);
				var r = Qt((.4124564 * e + .3575761 * t + .1804375 * n) / zt),
					i = Qt((.2126729 * e + .7151522 * t + .072175 * n) / Wt),
					s = Qt((.0193339 * e + .119192 * t + .9503041 * n) / Xt);
				return qt(116 * i - 16, 500 * (r - i), 200 * (i - s))
			}
			...
			function Ht(e, t, n) {
				...
				var r, i;
				return e %= 360, e < 0 && (e += 360), t = t < 0 ? 0 : t > 1 ? 1 : t, n = n < 0 ? 0 : n > 1 ? 1 : n, i = n <= .5 ? n * (1 + t) : n + t - n * t, r = 2 * n - i, St(o(e + 120), o(e), o(e - 120))
			}
			...
			function It(e, t, n) {
				return qt(n, Math.cos(e *= a) * t, Math.sin(e) * t)
			}
			...
			function $t(e, t, n) {
				var r = (e + 16) / 116,
					i = r + t / 500,
					s = r - n / 200;
				return i = Kt(i) * zt, r = Kt(r) * Wt, s = Kt(s) * Xt, St(Gt(3.2404542 * i - 1.5371385 * r - .4985314 * s), Gt(-0.969266 * i + 1.8760108 * r + .041556 * s), Gt(.0556434 * i - .2040259 * r + 1.0572252 * s))
			}

			function Jt(e, t, n) {
				return Bt(Math.atan2(n, t) / o * 180, Math.sqrt(t * t + n * n), e)
			}
			...
			function cn(e) {
				...
				return function(n, r) {
					...
					var i = n.className,
						s = i.baseVal != null,
						o = s ? i.baseVal : i;
					r ? (t.lastIndex = 0, t.test(o) || (o = L(o + " " + e), s ? i.baseVal = o : n.className = o)) : o && (o = L(o.replace(t, " ")), s ? i.baseVal = o : n.className = o)
				}
			}
			...
			function gn(e, t, n) {
				...
				function o() {
					...
					var i = this,
						o = p(arguments);
					s.call(this), this.addEventListener(e, this[r] = u, u.$ = n), u._ = t
				}
				var r = "__on" + e,
					i = e.indexOf(".");
				return i > 0 && (e = e.substring(0, i)), t ? o : s
			}
			...
			function kn(e, t, n, r) {
				...
				if(!s) {
					...
					return s = i[n] = {
						...
						function p(r) {
							return i.active > n ? v() : (i.active = n, f.start.call(e, u, t), s.tween.forEach(function(n, r) {
								(r = r.call(e, u, t)) && h.push(r)
							}), d(r) || d3.timer(d, 0, o), 1)
						}

						function d(r) {
							if(i.active !== n) return v();
							var s = (r - l) / c,
								o = a(s),
								p = h.length;
							while(p > 0) h[--p].call(e, o);
							if(s >= 1) return v(), f.end.call(e, u, t), 1
						}
						...
						var u = e.__data__,
							...
							c = s.duration,
							h = [];
						return l <= r ? p(r) : d3.timer(p, l, o), 1
					}, 0, o), s
				}
			}
			...
			function An(e, t, n, r) {
				var i = e.id;
				return yn(e, typeof n == "function" ? function(e, s, o) {
			...
			function Hn() {
				...
				var r = Bn() - t;
				r > 24 ? (isFinite(r) && (clearTimeout(Pn), Pn = setTimeout(Hn, r)), Dn = 0) : (Dn = 1, jn(Hn))
			}
			...
			function Bn() {
				var e = null,
					t = _n,
					n = Infinity;
				while(t) t.flush ? (delete Mn[t.callback.id], t = e ? e.next = t.next : _n = t.next) : (n = Math.min(n, t.then + t.delay), t = (e = t).next);
				return n
			}
			...
			function In(e, t) {
				...
				if(n.createSVGPoint) {
					...
					return Fn ? (r.x = t.pageX, r.y = t.pageY) : (r.x = t.clientX, r.y = t.clientY), r = r.matrixTransform(e.getScreenCTM().inverse()), [r.x, r.y]
				}
			...
			function Un(e) {
				return e.rangeExtent ? e.rangeExtent() : Rn(e.range())
			}
			...
			function Xn(e, t, n, r) {
				function o() {
					var o = Math.min(e.length, t.length) > 2 ? Yn : Gn,
						a = r ? wt : bt;
					return i = o(e, t, a, n), s = o(t, e, a, d3.interpolate), u
				}
				...
				return u.invert = function(e) {
					...
					return u.range(e).interpolate(d3.interpolateRound)
				}, u.clamp = function(e) {
			...
			function Kn(e, t) {
				return d3.range.apply(d3, Jn(e, t))
			}

			function Qn(e, t) {
				return d3.format(",." + Math.max(0, -Math.floor(Math.log(Jn(e, t)[2]) / Math.LN10 + .01)) + "f")
			}
			...
			function Zn(e, t) {
				...
				return r.invert = function(t) {
					...
					return arguments.length ? (t = i[0] < 0 ? nr : tr, n = t.pow, e.domain(i.map(t)), r) : e.domain().map(n)
				}, r.nice = function() {
					return e.domain(zn(e.domain(), Wn)), r
				}, r.ticks = function() {
					var r = Rn(e.domain()),
						i = [];
					if(r.every(isFinite)) {
						...
						if(t === nr) {
							i.push(n(s));
							for(; s++ < o;)
								for(var f = 9; f > 0; f--) i.push(n(s) * f)
						} else {
							for(; s < o; s++)
								for(var f = 1; f < 10; f++) i.push(n(s) * f);
							i.push(n(s))
						}
						for(s = 0; i[s] < u; s++);
					...
					arguments.length < 2 && (i = er);
					if(!arguments.length) return i;
					var s = Math.max(.1, e / r.ticks().length),
						o = t === nr ? (u = -1e-12, Math.floor) : (u = 1e-12, Math.ceil),
						u;
					return function(e) {
						return e / n(o(t(e) + u)) <= s ? i(e) : ""
					}
				}, r.copy = function() {
					return Zn(e.copy(), t)
				}, Vn(r, e)
			...
			function rr(e, t) {
				...
				return i.invert = function(t) {
					...
					return Kn(i.domain(), e)
				}, i.tickFormat = function(e) {
					return Qn(i.domain(), e)
				}, i.nice = function() {
					return i.domain(zn(i.domain(), $n))
				}, i.exponent = function(e) {
					if(!arguments.length) return t;
					var s = i.domain();
					return n = ir(t = e), r = ir(1 / t), i.domain(s)
				}, i.copy = function() {
					return rr(e.copy(), t)
				}, Vn(i, e)
			}
			...
			function sr(e, t) {
				function s(t) {
					return r[((n.get(t) || n.set(t, e.push(t))) - 1) % r.length]
				}
				...
				return s.domain = function(r) {
					...
					var i = -1,
						o = r.length,
						u;
					while(++i < o) n.has(u = r[i]) || n.set(u, e.push(u));
					return s[t.t].apply(s, t.a)
				}, s.range = function(e) {
					return arguments.length ? (r = e, i = 0, t = {
						t: "range",
						a: arguments
					}, s) : r
				}, s.rangePoints = function(n, u) {
					arguments.length < 2 && (u = 0);
					var a = n[0],
						f = n[1],
						l = (f - a) / (Math.max(1, e.length - 1) + u);
					return r = o(e.length < 2 ? (a + f) / 2 : a + l * u / 2, l), i = 0, t = {
						t: "rangePoints",
						a: arguments
					}, s
				}, s.rangeBands = function(n, u, a) {
					arguments.length < 2 && (u = 0), arguments.length < 3 && (a = u);
					var f = n[1] < n[0],
						l = n[f - 0],
						c = n[1 - f],
						h = (c - l) / (e.length - u + 2 * a);
					return r = o(l + h * a, h), f && r.reverse(), i = h * (1 - u), t = {
						t: "rangeBands",
						a: arguments
					}, s
				}, s.rangeRoundBands = function(n, u, a) {
					arguments.length < 2 && (u = 0), arguments.length < 3 && (a = u);
					var f = n[1] < n[0],
						l = n[f - 0],
						c = n[1 - f],
						h = Math.floor((c - l) / (e.length - u + 2 * a)),
						p = c - l - (e.length - u) * h;
					return r = o(l + Math.round(p / 2), h), f && r.reverse(), i = Math.round(h * (1 - u)), t = {
						t: "rangeRoundBands",
						a: arguments
					}, s
			...
			function lr(e, t) {
				function r() {
					var r = 0,
						s = t.length;
					n = [];
					while(++r < s) n[r - 1] = d3.quantile(e, r / s);
					return i
				}

				function i(e) {
					return isNaN(e = +e) ? NaN : t[d3.bisect(n, e)]
				}
				var n;
				return i.domain = function(t) {
					return arguments.length ? (e = t.filter(function(e) {
						return !isNaN(e)
					}).sort(d3.ascending), r()) : e
				}, i.range = function(e) {
			...
			function wr(e) {
				...
				return u.x = function(e) {
					...
					return arguments.length ? (typeof e == "function" ? s = i = e : s = (i = xr.get(e) || Tr).key, u) : s
			...
			function Lr(e, t) {
				return e.length < 4 ? Tr(e) : e[1] + Mr(e.slice(1, e.length - 1), _r(e, t))
			}

			function Ar(e, t) {
				return e.length < 3 ? Tr(e) : e[0] + Mr((e.push(e[0]), e), _r([e[e.length - 2]].concat(e, [e[1]]), t))
			}

			function Or(e, t) {
				return e.length < 3 ? Tr(e) : e[0] + Mr(e, _r(e, t))
			}

			function Mr(e, t) {
				if(t.length < 1 || e.length != t.length && e.length != t.length + 2) return Tr(e);
			...
			function Dr(e) {
				...
				var t = 1,
					...
					a = [i, ",", s];
				Rr(a, o, u);
				while(++t < n) r = e[t], o.shift(), o.push(r[0]), u.shift(), u.push(r[1]), Rr(a, o, u);
				t = -1;
				while(++t < 2) o.shift(), o.push(r[0]), u.shift(), u.push(r[1]), Rr(a, o, u);
				return a.join("")
			}

			function Pr(e) {
				if(e.length < 4) return Tr(e);
				var t = [],
					n = -1,
					r = e.length,
					i, s = [0],
				...
				t.push(jr(qr, s) + "," + jr(qr, o)), --n;
				while(++n < r) i = e[n], s.shift(), s.push(i[0]), o.shift(), o.push(i[1]), Rr(t, s, o);
				return t.join("")
			}
			...
			function Hr(e) {
				...
				t = [jr(qr, o), ",", jr(qr, u)], --n;
				while(++n < i) s = e[n % r], o.shift(), o.push(s[0]), u.shift(), u.push(s[1]), Rr(t, o, u);
				return t.join("")
			}
			...
			function Rr(e, t, n) {
				e.push("C", jr(Fr, t), ",", jr(Fr, n), ",", jr(Ir, t), ",", jr(Ir, n), ",", jr(qr, t), ",", jr(qr, n))
			}
			...
			function zr(e) {
				var t = 0,
					...
					s = e[1],
					o = r[0] = Ur(i, s);
				while(++t < n) r[t] = (o + (o = Ur(i = s, s = e[t + 1]))) / 2;
				return r[t] = o, r
			}
			...
			function Wr(e) {
				var t = [],
					...
					u = -1,
					a = e.length - 1;
				while(++u < a) n = Ur(e[u], e[u + 1]), Math.abs(n) < 1e-6 ? o[u] = o[u + 1] = 0 : (r = o[u] / n, i = o[u + 1] / n, s = r * r + i * i, s > 9 && (s = n * 3 / Math.sqrt(s), o[u] = s * r, o[u + 1] = s * i));
				u = -1;
			...
			function Xr(e) {
				return e.length < 3 ? Tr(e) : e[0] + Mr(e, Wr(e))
			}
			...
			function Vr(e) {
				var t, n = -1,
					r = e.length,
					i, s;
				while(++n < r) t = e[n], i = t[0], s = t[1] + dr, t[0] = i * Math.cos(s), t[1] = i * Math.sin(s);
				return e
			}
			...
			function $r(e) {
				function c(u) {
					...
					var c = [],
						...
						E, S;
					while(++d < v) s.call(this, m = u[d], d) ? (h.push([E = +g.call(this, m, d), S = +y.call(this, m, d)]), p.push([+b.call(this, m, d), +w.call(this, m, d)])) : h.length && (T(), h = [], p = []);
					return h.length && T(), c.length ? c.join("") : null
				}
				var t = Er,
					n = Er,
					r = 0,
				...
				return c.x = function(e) {
					...
					return arguments.length ? (typeof e == "function" ? u = o = e : u = (o = xr.get(e) || Tr).key, a = o.reverse || o, f = o.closed ? "M" : "L", c) : u
			...
			function li() {
				ai || (ai = d3.select("body").append("div").style("visibility", "hidden").style("top", 0).style("height", 0).style("width", 0).style("overflow-y", "scroll").append("div").style("height", "2000px").node().parentNode);
				var e = d3.event,
					t;
				try {
					ai.scrollTop = 1e3, ai.dispatchEvent(e), t = 1e3 - ai.scrollTop
				} catch(n) {
			...
			function yi(e, t, n) {
				...
				if(!e.leaf) {
					...
					while(++u < o) {
						a = s[u];
						if(a == null) continue;
						yi(a, t, n), e.charge += a.charge, r += a.charge * a.cx, i += a.charge * a.cy
					}
				}
				if(e.point) {
			...
			function _i(e, t) {
				return Di(e, Math.ceil(Math.log(t.length) / Math.LN2 + 1))
			}
			...
			function Hi(e, t) {
				return d3.rebind(e, t, "sort", "children", "value"), e.nodes = e, e.links = Ii, e
			}
			...
			function Wi(e) {
				...
				var t, n = Infinity,
					...
					s = -Infinity,
					o, u, a, f, l, c, h;
				t.forEach(Xi), o = t[0], o.x = -o.r, o.y = 0, p(o);
				if(h > 1) {
					u = t[1], u.x = u.r, u.y = 0, p(u);
					if(h > 2) {
						a = t[2], Ji(o, u, a), p(a), Ri(o, a), o._pack_prev = a, Ri(a, u), u = o._pack_next;
						for(f = 3; f < h; f++) {
							Ji(o, u, a = t[f]);
							var d = 0,
								v = 1,
							...
							if(d == 1)
								for(c = o._pack_prev; c !== l._pack_prev; c = c._pack_prev, m++)
									if(zi(c, a)) break;
							d ? (v < m || v == m && u.r < o.r ? Ui(o, u = l) : Ui(o = c, u), f--) : (Ri(o, a), u = a, p(a))
						}
					}
				}
				var g = (n + r) / 2,
			...
			function Gi(e) {
				var t = e.children;
				return t && t.length ? Gi(t[0]) : e
			}

			function Yi(e) {
				var t = e.children,
					n;
				return t && (n = t.length) ? Yi(t[n - 1]) : e
			}
			...
			function ns(e, t) {
				...
				if(n && (i = n.length)) {
					var r, i, s = -1;
					while(++s < i) t(r = ns(n[s], t), e) > 0 && (e = r)
				}
				return e
			}
			...
			function hs(e, t) {
				function i(e, n) {
					return d3.xhr(e, t, n).response(s)
				}
				...
				return i.parse = function(e) {
					var t;
					return i.parseRows(e, function(e) {
						if(t) return t(e);
						t = new Function("d", "return {" + e.map(function(e, t) {
			...
			function ps(e, t) {
				vs.hasOwnProperty(e.type) && vs[e.type](e, t)
			}
			...
			function bs(e, t) {
				return Math.abs(e[0] - t[0]) < u && Math.abs(e[1] - t[1]) < u
			}
			...
			function Cs(e) {
				...
				function i(n, r, s, o, a, f, l, c, h, p, d, v, m, g) {
					var y = l - n,
						b = c - r,
						w = y * y + b * b;
					if(w > 4 * t && m--) {
						var E = o + p,
							S = a + d,
							x = f + v,
							T = Math.sqrt(E * E + S * S + x * x),
							N = Math.asin(x /= T),
							C = Math.abs(Math.abs(x) - 1) < u ? (s + h) / 2 : Math.atan2(S, E),
							k = e(C, N),
							L = k[0],
							A = k[1],
							O = L - n,
							M = A - r,
							_ = b * O - y * M;
						if(_ * _ / w > t || Math.abs((y * O + b * M) / w - .5) > .3) i(n, r, s, o, a, f, L, A, C, E /= T, S /= T, x, m, g), g.point(L, A), i(L, A, C, E, S, x, l, c, h, p, d, v, m, g)
					}
				}
				var t = .5,
					n = 16;
			...
			function Os(e) {
				...
				return function(o) {
					return i = r = -(t = n = Infinity), d3.geo.stream(o, e(s)), [
						[t, n],
						[r, i]
					]
				}
			...
			function js(e, t) {
				...
				++_s, e *= a;
				var n = Math.cos(t *= a);
				Ds += (n * Math.cos(e) - Ds) / _s, Ps += (n * Math.sin(e) - Ps) / _s, Hs += (Math.sin(t) - Hs) / _s
			}
			...
			function Fs() {
				...
				Ms = 1, Is(), Ms = 2;
				var n = Bs.point;
				Bs.point = function(r, i) {
					n(e = r, t = i)
				}, Bs.lineEnd = function() {
					Bs.point(e, t), qs(), Bs.lineEnd = qs
				}
			}
			...
			function Is() {
				function r(r, i) {
					...
					var s = Math.cos(i *= a),
						...
						u = s * Math.sin(r),
						f = Math.sin(i),
						l = Math.atan2(Math.sqrt((l = t * f - n * u) * l + (l = n * o - e * f) * l + (l = e * u - t * o) * l), e * o + t * u + n * f);
					_s += l, Ds += l * (e + (e = o)), Ps += l * (t + (t = u)), Hs += l * (n + (n = f))
				}
				var e, t, n;
				if(Ms > 1) return;
				Ms < 1 && (Ms = 1, _s = Ds = Ps = Hs = 0), Bs.point = function(i, s) {
					i *= a;
					var o = Math.cos(s *= a);
					e = o * Math.cos(i), t = o * Math.sin(i), n = Math.sin(s), Bs.point = r
				}
			}
			...
			function Rs(e, t) {
				...
				return function(i, s, u, a) {
					if(i != null) {
						i = Us(n, i), s = Us(n, s);
						if(u > 0 ? i < s : i > s) i += u * 2 * o
					} else i = e + u * 2 * o, s = e;
					var f;
					for(var l = u * t, c = i; u > 0 ? c > s : c < s; c -= l) a.point((f = ys([n, -r * Math.cos(c), -r * Math.sin(c)]))[0], f[1])
				}
			}
			...
			function Us(e, t) {
				...
				return((-n[2] < 0 ? -r : r) + 2 * Math.PI - u) % (2 * Math.PI)
			}
					...
					function w() {
						...
						if(e & 1) {
							...
							var i = n.length - 1,
								...
								o;
							r.lineStart();
							while(++s < i) r.point((o = n[s])[0], o[1]);
							r.lineEnd();
							return
						}
						i > 1 && e & 2 && t.push(t.pop().concat(t.shift())), c.push(t.filter($s))
					}
					var i = t(r),
						s = {
							point: o,
							...
							lineEnd: l,
							polygonStart: function() {
								s.point = y, s.lineStart = b, s.lineEnd = w, d = !1, p = h = 0, c = [], r.polygonStart()
							},
							polygonEnd: function() {
								s.point = o, s.lineStart = f, s.lineEnd = l, c = d3.merge(c);
								if(c.length) Ws(c, n, r);
								else if(h < -u || d && p < -u) r.lineStart(), n(null, null, 1, r), r.lineEnd();
								r.polygonEnd(), c = null
							},
							sphere: function() {
			...
			function Ws(e, t, n) {
				...
				for(;;) {
					o = s;
					while(o.visited)
						if((o = o.next) === s) return;
					u = o.points, n.lineStart();
					do {
						o.visited = o.other.visited = !0;
						if(o.entry) {
							if(o.subject)
								for(var f = 0; f < u.length; f++) n.point((a = u[f])[0], a[1]);
							else t(o.point, o.next.point, 1, n);
							o = o.next
						} else {
							if(o.subject) {
								u = o.prev.points;
								for(var f = u.length; --f >= 0;) n.point((a = u[f])[0], a[1])
							} else t(o.point, o.prev.point, -1, n);
							o = o.prev
						}
						o = o.other, u = o.points
					} while (!o.visited);
					n.lineEnd()
				}
			}
			...
			function Vs(e, t) {
				return((e = e.point)[0] < 0 ? e[1] - o / 2 - u : o / 2 - e[1]) - ((t = t.point)[0] < 0 ? t[1] - o / 2 - u : o / 2 - t[1])
			}
			...
			function Ks(e, t) {
				...
				var n, r = 0,
					...
					f = s[1],
					l = Math.cos(f),
					c = Math.atan2(t * Math.sin(a) * l, Math.sin(f)),
					h = 1 - t * Math.cos(a) * l,
					p = c,
					d, v;
				while(++r < n) {
					s = e[r], l = Math.cos(f = s[1]), d = Math.atan2(t * Math.sin(a = s[0]) * l, Math.sin(f)), v = 1 - t * Math.cos(a) * l;
					if(Math.abs(h - 2) < u && Math.abs(v - 2) < u) continue;
					Math.abs(v) < u || Math.abs(h) < u || (Math.abs(Math.abs(d - c) - o) < u ? v + h > 2 && (i += 4 * (d - c)) : Math.abs(h - 2) < u ? i += 4 * (d - p) : i += ((3 * o + d - c) % (2 * o) - o) * (h + v)), p = c, c = d, h = v
				}
				return i
			}
			...
			function Gs(e) {
				...
				return {
					...
					point: function(s, a) {
						var f = s > 0 ? o : -o,
							l = Math.abs(s - t);
						Math.abs(l - o) < u ? (e.point(t, n = (n + a) / 2 > 0 ? o / 2 : -o / 2), e.point(r, n), e.lineEnd(), e.lineStart(), e.point(f, n), e.point(s, n), i = 0) : r !== f && l >= o && (Math.abs(t - r) < u && (t -= r * u), Math.abs(s - f) < u && (s -= f * u), n = Ys(t, n, s, a), e.point(r, n), e.lineEnd(), e.lineStart(), e.point(f, n), i = 0), e.point(t = s, n = a), r = f
					},
					lineEnd: function() {
						e.lineEnd(), t = n = NaN
					},
			...
			function Ys(e, t, n, r) {
				...
				return Math.abs(o) > u ? Math.atan((Math.sin(t) * (s = Math.cos(r)) * Math.sin(n) - Math.sin(r) * (i = Math.cos(t)) * Math.sin(e)) / (i * s * o)) : (t + r) / 2
			}

			function Zs(e, t, n, r) {
				var i;
				if(e == null) i = n * o / 2, r.point(-o, i), r.point(0, i), r.point(o, i), r.point(o, 0), r.point(o, -i), r.point(0, -i), r.point(-o, -i), r.point(-o, 0), r.point(-o, i);
				else if(Math.abs(e[0] - t[0]) > u) {
					var s = (e[0] < t[0] ? 1 : -1) * o;
				...
				function s(e) {
					...
					return {
						...
						point: function(a, f) {
							...
							if(h !== n) {
								c = o(t, l);
								if(bs(t, c) || bs(l, c)) l[0] += u, l[1] += u, h = i(l[0], l[1])
							}
							h !== n && (s = 0, (n = h) ? (e.lineStart(), c = o(l, t), e.point(c[0], c[1])) : (c = o(t, l), e.point(c[0], c[1]), e.lineEnd()), t = c), h && (!t || !bs(t, l)) && e.point(l[0], l[1]), t = l
						},
						lineEnd: function() {
							n && e.lineEnd(), t = null
						},
			...
			function io(e, t, n) {
				var r = d3.range(e, t - u, n).concat(t);
				return function(e) {
			...
			function oo(e, t, n, r) {
				function v(e) {
					var t = Math.sin(e *= p) * d,
						...
						i = n * l + t * h,
						o = n * s + t * u;
					return [Math.atan2(i, r) / a, Math.atan2(o, Math.sqrt(r * r + i * i)) / a]
				}
				var i = Math.cos(t),
					s = Math.sin(t),
					o = Math.cos(r),
					...
					c = o * Math.cos(n),
					h = o * Math.sin(n),
					p = Math.acos(Math.max(-1, Math.min(1, s * u + i * o * Math.cos(n - e)))),
					d = 1 / Math.sin(p);
				return v.distance = p, v
			}

			function uo(e, t) {
				return [e / (2 * o), Math.max(-0.5, Math.min(.5, Math.log(Math.tan(o / 4 + t / 2)) / (2 * o)))]
			}
			...
			function ho(e) {
				function r(n, r) {
					e.moveTo(n, r), e.arc(n, r, t, 0, 2 * o)
				}
			...
			function go() {
				...
				var e, t, n, r;
				mo.point = function(s, o) {
					mo.point = i, e = n = s, t = r = o
				}, mo.lineEnd = function() {
					i(e, t)
				}
			}
			...
			function wo() {
				function n(n, r) {
					var i = n - e,
						s = r - t,
						o = Math.sqrt(i * i + s * s);
					Ds += o * (e + n) / 2, Ps += o * (t + r) / 2, Hs += o, e = n, t = r
				}
				var e, t;
				if(Ms !== 1) {
					if(!(Ms < 1)) return;
			...
			function So() {
				function i(e, t) {
					var i = r * e - n * t;
					Ds += i * (n + e), Ps += i * (r + t), Hs += i * 3, n = e, r = t
				}
				var e, t, n, r;
				Ms < 2 && (Ms = 2, Ds = Ps = Hs = 0), yo.point = function(s, o) {
					yo.point = i, e = n = s, t = r = o
				}, yo.lineEnd = function() {
					i(e, t)
				}
			}
			...
			function Co() {
				function l(e, t) {
					e *= a, t *= a;
					if(Math.abs(Math.abs(i) - o / 2) < u && Math.abs(Math.abs(t) - o / 2) < u) return;
					var l = Math.cos(t),
						c = Math.sin(t);
					if(Math.abs(i - o / 2) < u) To += (e - n) * 2;
					else {
						var h = e - r,
							p = Math.cos(h),
							d = Math.atan2(Math.sqrt((d = l * Math.sin(h)) * d + (d = s * c - f * l * p) * d), f * c + s * l * p),
							v = (d + o + i + t) / 4;
						To += (h < 0 && h > -o || h > o ? -4 : 4) * Math.atan(Math.sqrt(Math.abs(Math.tan(v) * Math.tan(v - d / 2) * Math.tan(v - o / 4 - i / 2) * Math.tan(v - o / 4 - t / 2))))
					}
					n = r, r = e, i = t, s = l, f = c
				}
				var e, t, n, r, i, s, f;
				No.point = function(o, u) {
					No.point = l, n = r = (e = o) * a, i = (t = u) * a, s = Math.cos(i), f = Math.sin(i)
				}, No.lineEnd = function() {
					l(e, t)
				}
			}
			...
			function Lo(e) {
				function b(e) {
					return e = r(e[0] * a, e[1] * a), [e[0] * s + v, m - e[1] * s]
				}

				function w(e) {
					return e = r.invert((e[0] - v) / s, (m - e[1]) / s), e && [e[0] * f, e[1] * f]
				}

				function E() {
					r = to(n = Oo(h, p, d), t);
					var e = t(l, c);
					return v = o - e[0] * s, m = u + e[1] * s, b
				}
				var t, n, r, i = Cs(function(e, n) {
						return e = t(e, n), [e[0] * s + v, m - e[1] * s]
					}),
					s = 150,
					o = 480,
					u = 250,
					...
					v, m, g = Qs,
					y = null;
				return b.stream = function(e) {
						return Ao(n, g(i(e)))
					}, b.clipAngle = function(e) {
						return arguments.length ? (g = e == null ? (y = e, Qs) : eo(y = +e), b) : y
					}, b.scale = function(e) {
						return arguments.length ? (s = +e, E()) : s
					}, b.translate = function(e) {
						return arguments.length ? (o = +e[0], u = +e[1], E()) : [o, u]
					}, b.center = function(e) {
						return arguments.length ? (l = e[0] % 360 * a, c = e[1] % 360 * a, E()) : [l * f, c * f]
					}, b.rotate = function(e) {
						return arguments.length ? (h = e[0] % 360 * a, p = e[1] % 360 * a, d = e.length > 2 ? e[2] % 360 * a : 0, E()) : [h * f, p * f, d * f]
					}, d3.rebind(b, i, "precision"),
					function() {
						return t = e.apply(this, arguments), b.invert = t.invert && w, E()
					}
			}
			...
			function Ao(e, t) {
				return {
					point: function(n, r) {
						r = e(n * a, r * a), n = r[0], t.point(n > o ? n - 2 * o : n < -o ? n + 2 * o : n, r[1])
					},
					sphere: function() {
						t.sphere()
					},
			...
			function Oo(e, t, n) {
				return e ? t || n ? to(_o(e), Do(t, n)) : _o(e) : t || n ? Do(t, n) : no
			}

			function Mo(e) {
				return function(t, n) {
					return t += e, [t > o ? t - 2 * o : t < -o ? t + 2 * o : t, n]
				}
			}

			function _o(e) {
				var t = Mo(e);
				return t.invert = Mo(-e), t
			}
			...
			function qo(e, t) {
				var n = {
					...
					r = {
						...
						rightRegion: function(e) {
							return e.edge == null ? n.bottomSite : e.edge.region[Io[e.side]]
						}
					},
					i = {
						bisect: function(e, t) {
				...
				for(;;) {
					...
					if(o && (s.empty() || o.y < u.y || o.y == u.y && o.x < u.x)) a = r.leftBound(o), f = r.right(a), p = r.rightRegion(a), y = i.bisect(p, o), h = r.createHalfEdge(y, "l"), r.insert(a, h), m = i.intersect(a, h), m && (s.del(a), s.insert(a, m, i.distance(m, o))), a = h, h = r.createHalfEdge(y, "r"), r.insert(a, h), m = i.intersect(h, f), m && s.insert(h, m, i.distance(m, o)), o = n.list.shift();
						...
						if(!!s.empty()) break;
						a = s.extractMin(), l = r.left(a), f = r.right(a), c = r.right(f), p = r.leftRegion(a), d = r.rightRegion(f), g = a.vertex, i.endPoint(a.edge, a.side, g), i.endPoint(f.edge, f.side, g), r.del(a), s.del(f), r.del(f), b = "l", p.y > d.y && (v = p, p = d, d = v, b = "r"), y = i.bisect(p, d), h = r.createHalfEdge(y, b), r.insert(l, h), i.endPoint(y, Io[b], g), m = i.intersect(l, h), m && (s.del(l), s.insert(l, m, i.distance(m, p))), m = i.intersect(h, c), m && s.insert(h, m, i.distance(m, p))
					}
				}
			...
			function Uo(e, t, n, r, i, s) {
				if(!e(t, n, r, i, s)) {
					var o = (n + i) * .5,
						u = (r + s) * .5,
						a = t.nodes;
					a[0] && Uo(e, a[0], n, r, o, u), a[1] && Uo(e, a[1], o, r, i, u), a[2] && Uo(e, a[2], n, u, o, s), a[3] && Uo(e, a[3], o, u, i, s)
				}
			}
			...
			function pu(e, t, n) {
				su.lastIndex = 0;
				var r = su.exec(t.substring(n));
				return r ? n += r[0].length : -1
			}

			function du(e, t, n) {
				iu.lastIndex = 0;
				var r = iu.exec(t.substring(n));
				return r ? n += r[0].length : -1
			}

			function vu(e, t, n) {
				au.lastIndex = 0;
				var r = au.exec(t.substring(n));
				return r ? (e.m = fu.get(r[0].toLowerCase()), n += r[0].length) : -1
			}

			function mu(e, t, n) {
				ou.lastIndex = 0;
				var r = ou.exec(t.substring(n));
				return r ? (e.m = uu.get(r[0].toLowerCase()), n += r[0].length) : -1
			}

			function gu(e, t, n) {
				return eu(e, cu.c.toString(), t, n)
			}

			function yu(e, t, n) {
				return eu(e, cu.x.toString(), t, n)
			}
			...
			function wu(e, t, n) {
				Au.lastIndex = 0;
				var r = Au.exec(t.substring(n, n + 4));
				return r ? (e.y = +r[0], n += r[0].length) : -1
			}

			function Eu(e, t, n) {
				Au.lastIndex = 0;
				var r = Au.exec(t.substring(n, n + 2));
				return r ? (e.y = Su(+r[0]), n += r[0].length) : -1
			}
			...
			function Lu(e, t, n) {
				Au.lastIndex = 0;
				var r = Au.exec(t.substring(n, n + 3));
				return r ? (e.L = +r[0], n += r[0].length) : -1
			}

			function Ou(e, t, n) {
				var r = Mu.get(t.substring(n, n += 2).toLowerCase());
			...
			function Hu(e, t, n) {
				...
				function i(n) {
					return t(n = e(new zo(n - 1)), 1), n
				}

				function s(e, n) {
					return t(e = new zo(+e), n), e
				}
				...
				var a = e.utc = Bu(e);
				return a.floor = a, a.round = Bu(r), a.ceil = Bu(i), a.offset = Bu(s), a.range = u, e
			}
			...
			function ju(e, t, n) {
				...
				return r.invert = function(t) {
					return Iu(e.invert(t))
				}, r.domain = function(t) {
					return arguments.length ? (e.domain(t), r) : e.domain().map(Iu)
				}, r.nice = function(e) {
					return r.domain(zn(r.domain(), function() {
						return e
					}))
					...
					if(typeof n != "function") {
						var o = s[1] - s[0],
							u = o / n,
							a = d3.bisect(zu, u);
						if(a == zu.length) return t.year(s, n);
						if(!a) return e.ticks(n).map(Iu);
						Math.log(u / zu[a - 1]) < Math.log(zu[a] / u) && --a, n = t[a], i = n[1], n = n[0].range
					}
					return n(s[0], new Date(+s[1] + 1), i)
				}, r.tickFormat = function() {
					return n
				}, r.copy = function() {
					return ju(e.copy(), t, n)
			...
			try {
				...
				var i = CSSStyleDeclaration.prototype,
					s = i.setProperty;
			...
			var o = Math.PI,
				...
				p = v;
			try {
				p(document.documentElement.childNodes)[0].nodeType
			} catch(m) {
				p = d
			}
			var g = [].__proto__ ? function(e, t) {
				e.__proto__ = t
			} : function(e, t) {
				for(var n in t) e[n] = t[n]
			};
			d3.map = function(e) {
				...
				remove: function(e) {
					return e = b + e, e in this && delete this[e]
				},
				keys: function() {
					var e = [];
				...
				forEach: function(e) {
					for(var t in this) t.charCodeAt(0) === w && e.call(this, t.substring(1), this[t])
				}
			});
			var b = "\0",
				w = b.charCodeAt(0);
			d3.functor = x, d3.rebind = function(e, t) {
				var n = 1,
					r = arguments.length,
					i;
				while(++n < r) e[i = arguments[n]] = T(e, t, t[i]);
				return e
				...
				if(arguments.length === 1)
					while(++s < n) N(r = e[s]) && (i += (r - i) / ++o);
				else
					while(++s < n) N(r = t.call(e, e[s], s)) && (i += (r - i) / ++o);
				return o ? i : undefined
			}, d3.median = function(e, t) {
				return arguments.length > 1 && (e = e.map(t)), e = e.filter(N), e.length ? d3.quantile(e.sort(d3.ascending), .5) : undefined
			}, d3.min = function(e, t) {
				var n = -1,
					r = e.length,
					i, s;
				...
				for(var e = -1, t = d3.min(arguments, C), n = new Array(t); ++e < t;)
			...
			var k = d3.bisector(function(e) {
				return e
			});
			d3.bisectLeft = k.left, d3.bisect = d3.bisectRight = k.right, d3.nest = function() {
				function s(n, o) {
					if(o >= t.length) return i ? i.call(e, n) : r ? n.sort(r) : n;
					var u = -1,
						a = n.length,
						f = t[o++],
						l, c, h = new y,
						p, d = {};
					while(++u < a)(p = h.get(l = f(c = n[u]))) ? p.push(c) : h.set(l, [c]);
				...
				return e.map = function(e) {
					...
					return t.push(n), e
				}, e.sortKeys = function(r) {
					return n[t.length - 1] = r, e
			...
			d3.round = function(e, t) {
				...
				function a() {
					var e = u.status;
					!e && u.responseText || e >= 200 && e < 300 || e === 304 ? i.load.call(r, o.call(r, u)) : i.error.call(r, u)
				}
				var r = {},
					i = d3.dispatch("progress", "load", "error"),
					s = {},
					o = E,
					u = new(window.XDomainRequest && /^(http(s)?:)?\/\//.test(e) ? XDomainRequest : XMLHttpRequest);
				return "onload" in u ? u.onload = u.onerror = a : u.onreadystatechange = function() {
					u.readyState > 3 && a()
					...
					return e = (e + "").toLowerCase(), arguments.length < 2 ? s[e] : (t == null ? delete s[e] : s[e] = t + "", r)
				}, r.mimeType = function(e) {
					return arguments.length ? (t = e == null ? null : e + "", r) : t
				}, r.response = function(e) {
					return o = e, r
				}, ["get", "post"].forEach(function(e) {
					r[e] = function() {
						return r.send.apply(r, [e].concat(p(arguments)))
					}
				}), r.send = function(n, i, o) {
					arguments.length === 2 && typeof i == "function" && (o = i, i = null), u.open(n, e, !0), t != null && !("accept" in s) && (s.accept = t + ",*/*");
					if(u.setRequestHeader)
						for(var a in s) u.setRequestHeader(a, s[a]);
					return t != null && u.overrideMimeType && u.overrideMimeType(t), o != null && r.on("error", o).on("load", function(e) {
						o(null, e)
					}), u.send(i == null ? null : i), r
				}, r.abort = function() {
					return u.abort(), r
				}, d3.rebind(r, i, "on"), arguments.length === 2 && typeof t == "function" && (n = t, t = null), n == null ? r : r.get(M(n))
			}, d3.text = function() {
				return d3.xhr.apply(d3, arguments).response(_)
			}, d3.json = function(e, t) {
				return d3.xhr(e, "application/json", t).response(D)
			}, d3.html = function(e, t) {
				return d3.xhr(e, "text/html", t).response(P)
			}, d3.xml = function() {
				return d3.xhr.apply(d3, arguments).response(H)
			};
			var B = {
			...
			d3.ns = {
				...
				qualify: function(e) {
					var t = e.indexOf(":"),
						n = e;
					return t >= 0 && (n = e.substring(0, t), e = e.substring(t + 1)), B.hasOwnProperty(n) ? {
						space: B[n],
						local: e
					} : e
				}
				...
				o === "#" && (o = ""), c == "r" && !l && (c = "g"), c = q.get(c) || U;
				var v = u && f;
				return function(t) {
					if(d && t % 1) return "";
					var n = t < 0 || t === 0 && 1 / t < 0 ? (t = -t, "-") : s;
					if(h < 0) {
						var m = d3.formatPrefix(t, l);
						t = m.scale(t), p = m.symbol
					} else t *= h;
					t = c(t, l), !u && f && (t = z(t));
					var g = o.length + t.length + (v ? 0 : n.length),
						y = g < a ? (new Array(g = a - g + 1)).join(r) : "";
					return v && (t = z(y + t)), e && t.replace(".", e), n += o, (i === "<" ? n + t + y : i === ">" ? y + n + t : i === "^" ? y.substring(0, g >>= 1) + n + t + y.substring(g) : n + (v ? t : y + t)) + p
				}
			};
			var I = /(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?([0-9]+)?(,)?(\.[0-9]+)?([a-zA-Z%])?/,
				q = d3.map({
					b: function(e) {
						return e.toString(2)
					},
					...
					r: function(e, t) {
						return d3.round(e, t = R(e, t)).toFixed(Math.max(0, Math.min(20, t)))
					}
				}),
				z = E;
			if(n) {
				...
				z = function(e) {
					var r = e.lastIndexOf("."),
						i = r >= 0 ? "." + e.substring(r + 1) : (r = e.length, ""),
						s = [],
						o = 0,
						u = n[0];
					while(r > 0 && u > 0) s.push(e.substring(r -= u, r + u)), u = n[o = (o + 1) % W];
					return s.reverse().join(t || "") + i
				}
			}
			var X = ["y", "z", "a", "f", "p", "n", "μ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(V);
			d3.formatPrefix = function(e, t) {
				var n = 0;
				return e && (e < 0 && (e *= -1), t && (e = d3.round(e, R(e, t))), n = 1 + Math.floor(1e-12 + Math.log(e) / Math.LN10), n = Math.max(-24, Math.min(24, Math.floor((n <= 0 ? n + 1 : n - 1) / 3) * 3))), X[8 + n / 3]
			};
			var $ = function() {
					return E
				},
			...
			d3.ease = function(e) {
				...
				return n = J.get(n) || $, r = K.get(r) || E, Q(r(n.apply(null, Array.prototype.slice.call(arguments, 1))))
			...
			d3.interpolate = function(e, t) {
				...
				var n, r, i, s = 0,
					...
					f, l;
				gt.lastIndex = 0;
				for(r = 0; n = gt.exec(t); ++r) n.index && u.push(t.substring(s, o = n.index)), a.push({
					i: u.length,
					x: n[0]
				}), u.push(null), s = gt.lastIndex;
				...
				var n = e.r,
					...
					u = t.b - i;
				return function(e) {
					return "#" + Nt(Math.round(n + s * e)) + Nt(Math.round(r + o * e)) + Nt(Math.round(i + u * e))
				}
				...
				var n = {},
					r = {},
					i;
				for(i in e) i in t ? n[i] = yt(i)(e[i], t[i]) : r[i] = e[i];
			...
			d3.interpolators = [d3.interpolateObject, function(e, t) {
				...
				return(typeof t == "string" ? Mt.has(t) || /^(#|rgb\(|hsl\()/.test(t) : t instanceof Et) && d3.interpolateRgb(e, t)
			}, function(e, t) {
				return !isNaN(e = +e) && !isNaN(t = +t) && d3.interpolateNumber(e, t)
			}], Et.prototype.toString = function() {
				return this.rgb() + ""
			}, d3.rgb = function(e, t, n) {
				return arguments.length === 1 ? e instanceof xt ? St(e.r, e.g, e.b) : Ct("" + e, St, Ht) : St(~~e, ~~t, ~~n)
			};
			var Tt = xt.prototype = new Et;
			Tt.brighter = function(e) {
				...
				var t = this.r,
					...
					r = this.b,
					i = 30;
				return !t && !n && !r ? St(i, i, i) : (t && t < i && (t = i), n && n < i && (n = i), r && r < i && (r = i), St(Math.min(255, Math.floor(t / e)), Math.min(255, Math.floor(n / e)), Math.min(255, Math.floor(r / e))))
			}, Tt.darker = function(e) {
				return e = Math.pow(.7, arguments.length ? e : 1), St(Math.floor(e * this.r), Math.floor(e * this.g), Math.floor(e * this.b))
			}, Tt.hsl = function() {
			...
			Mt.forEach(function(e, t) {
				...
				return arguments.length === 1 ? e instanceof Dt ? _t(e.h, e.s, e.l) : Ct("" + e, kt, _t) : _t(+e, +t, +n)
			};
			var Pt = Dt.prototype = new Et;
			Pt.brighter = function(e) {
				return e = Math.pow(.7, arguments.length ? e : 1), _t(this.h, this.s, this.l / e)
			}, Pt.darker = function(e) {
				return e = Math.pow(.7, arguments.length ? e : 1), _t(this.h, this.s, e * this.l)
			}, Pt.rgb = function() {
				return Ht(this.h, this.s, this.l)
			}, d3.hcl = function(e, t, n) {
				return arguments.length === 1 ? e instanceof jt ? Bt(e.h, e.c, e.l) : e instanceof Rt ? Jt(e.l, e.a, e.b) : Jt((e = Lt((e = d3.rgb(e)).r, e.g, e.b)).l, e.a, e.b) : Bt(+e, +t, +n)
			};
			var Ft = jt.prototype = new Et;
			Ft.brighter = function(e) {
				return Bt(this.h, this.c, Math.min(100, this.l + Ut * (arguments.length ? e : 1)))
			}, Ft.darker = function(e) {
				return Bt(this.h, this.c, Math.max(0, this.l - Ut * (arguments.length ? e : 1)))
			}, Ft.rgb = function() {
				return It(this.h, this.c, this.l).rgb()
			}, d3.lab = function(e, t, n) {
				return arguments.length === 1 ? e instanceof Rt ? qt(e.l, e.a, e.b) : e instanceof jt ? It(e.l, e.c, e.h) : Lt((e = d3.rgb(e)).r, e.g, e.b) : qt(+e, +t, +n)
			};
			var Ut = 18,
				zt = .95047,
				Wt = 1,
				Xt = 1.08883,
				Vt = Rt.prototype = new Et;
			Vt.brighter = function(e) {
				return qt(Math.min(100, this.l + Ut * (arguments.length ? e : 1)), this.a, this.b)
			}, Vt.darker = function(e) {
				return qt(Math.max(0, this.l - Ut * (arguments.length ? e : 1)), this.a, this.b)
			}, Vt.rgb = function() {
				return $t(this.l, this.a, this.b)
			};
			var Zt = function(e, t) {
				...
				nn = tn.matchesSelector || tn.webkitMatchesSelector || tn.mozMatchesSelector || tn.msMatchesSelector || tn.oMatchesSelector,
				rn = function(e, t) {
					return nn.call(e, t)
				};
			typeof Sizzle == "function" && (Zt = function(e, t) {
			...
			d3.selection = function() {
				return bn
			}, d3.selection.prototype = sn, sn.select = function(e) {
				var t = [],
					n, r, i, s;
				...
				return Yt(t)
			}, sn.selectAll = function(e) {
				var t = [],
					n, r;
				typeof e != "function" && (e = un(e));
				for(var i = -1, s = this.length; ++i < s;)
					for(var o = this[i], u = -1, a = o.length; ++u < a;)
						if(r = o[u]) t.push(n = p(e.call(r, r.__data__, u))), n.parentNode = r;
				return Yt(t)
			}, sn.attr = function(e, t) {
				if(arguments.length < 2) {
					if(typeof e == "string") {
						var n = this.node();
						return e = d3.ns.qualify(e), e.local ? n.getAttributeNS(e.space, e.local) : n.getAttribute(e)
					}
					for(t in e) this.each(an(t, e[t]));
					return this
				}
				return this.each(an(e, t))
			}, sn.classed = function(e, t) {
				if(arguments.length < 2) {
					if(typeof e == "string") {
						var n = this.node(),
						...
						if(t = n.classList) {
							...
							while(++i < r)
								if(!fn(e[i]).test(t)) return !1
						}
						return !0
					}
					for(t in e) this.each(ln(t, e[t]));
					return this
				}
				return this.each(ln(e, t))
			}, sn.style = function(e, t, n) {
				var r = arguments.length;
				if(r < 3) {
					if(typeof e != "string") {
						r < 2 && (t = "");
						for(n in e) this.each(hn(n, e[n], t));
						return this
					}
					if(r < 2) return getComputedStyle(this.node(), null).getPropertyValue(e);
					n = ""
				}
				return this.each(hn(e, t, n))
			}, sn.property = function(e, t) {
				if(arguments.length < 2) {
					if(typeof e == "string") return this.node()[e];
					for(t in e) this.each(pn(t, e[t]));
					return this
				}
				return this.each(pn(e, t))
			}, sn.text = function(e) {
			...
			}, sn.insert = function(e, t) {
				function n() {
					return this.insertBefore(document.createElementNS(this.namespaceURI, e), Zt(t, this))
				}

				function r() {
					return this.insertBefore(document.createElementNS(e.space, e.local), Zt(t, this))
				}
				...
				function o(e, n) {
					...
					if(t) {
						var v = new y,
							...
							g = [],
							b;
						for(r = -1; ++r < i;) b = t.call(p = e[r], p.__data__, r), v.has(b) ? h[r] = p : v.set(b, p), g.push(b);
						for(r = -1; ++r < s;) b = t.call(n, d = n[r], r), (p = v.get(b)) ? (l[r] = p, p.__data__ = d) : m.has(b) || (c[r] = dn(d)), m.set(b, d), v.remove(b);
						for(r = -1; ++r < i;) v.has(g[r]) && (h[r] = e[r])
					} else {
						for(r = -1; ++r < o;) p = e[r], d = n[r], p ? (p.__data__ = d, l[r] = p) : c[r] = dn(d);
						for(; r < s; ++r) c[r] = dn(n[r]);
						for(; r < i; ++r) h[r] = e[r]
					}
				...
				return this.order()
			}, sn.on = function(e, t, n) {
				var r = arguments.length;
				if(r < 3) {
					if(typeof e != "string") {
						r < 2 && (t = !1);
						for(n in e) this.each(gn(n, e[n], t));
						return this
					}
					if(r < 2) return(r = this.node()["__on" + e]) && r._;
					n = !1
				}
				return this.each(gn(e, t, n))
			}, sn.each = function(e) {
				return yn(this, function(t, n, r) {
				...
				var e = Nn || ++Tn,
					t = [],
					n, r, i = Object.create(Cn);
				i.time = Date.now();
				for(var s = -1, o = this.length; ++s < o;) {
					t.push(n = []);
					for(var u = this[s], a = -1, f = u.length; ++a < f;)(r = u[a]) && kn(r, a, e, i), n.push(r)
				}
				return Sn(t, e)
			};
			var bn = Yt([
			...
			bn[0].parentNode = tn, d3.select = function(e) {
				return typeof e == "string" ? bn.select(e) : Yt([
					[e]
				])
			}, d3.selectAll = function(e) {
				return typeof e == "string" ? bn.selectAll(e) : Yt([p(e)])
			};
			var En = [];
			d3.selection.enter = wn, d3.selection.enter.prototype = En, En.append = sn.append, En.insert = sn.insert, En.empty = sn.empty, En.node = sn.node, En.select = function(e) {
				var t = [],
					n, r, i, s, o;
			...
			xn.call = sn.call, xn.empty = sn.empty, xn.node = sn.node, d3.transition = function(e) {
				return arguments.length ? Nn ? e.transition() : e : bn.transition()
			}, d3.transition.prototype = xn, xn.select = function(e) {
				var t = this.id,
					n = [],
					r, i, s;
				typeof e != "function" && (e = on(e));
				for(var o = -1, u = this.length; ++o < u;) {
					n.push(r = []);
					for(var a = this[o], f = -1, l = a.length; ++f < l;)(s = a[f]) && (i = e.call(s, s.__data__, f)) ? ("__data__" in s && (i.__data__ = s.__data__), kn(i, f, t, s.__transition__[t]), r.push(i)) : r.push(null)
				}
				return Sn(n, t)
			}, xn.selectAll = function(e) {
				var t = this.id,
					n = [],
					r, i, s, o, u;
				typeof e != "function" && (e = un(e));
				for(var a = -1, f = this.length; ++a < f;)
					for(var l = this[a], c = -1, h = l.length; ++c < h;)
						if(s = l[c]) {
							...
							for(var p = -1, d = i.length; ++p < d;) kn(o = i[p], p, t, u), r.push(o)
						}
				return Sn(n, t)
				...
				return Sn(t, this.id, this.time).ease(this.ease())
			}, xn.attr = function(e, t) {
				function i() {
				...
				var n = yt(e),
					r = d3.ns.qualify(e);
				return An(this, "attr." + e, t, function(e) {
					function t() {
						var t = this.getAttribute(r),
							i;
						return t !== e && (i = n(t, e), function(e) {
					...
					return e == null ? r.local ? s : i : (e += "", r.local ? o : t)
				})
			}, xn.attrTween = function(e, t) {
				function r(e, r) {
				...
				function i(e, r) {
					var i = t.call(this, e, r, this.getAttributeNS(n.space, n.local));
					return i && function(e) {
						this.setAttributeNS(n.space, n.local, i(e))
					}
				}
				var n = d3.ns.qualify(e);
				return this.tween("attr." + e, n.local ? i : r)
			}, xn.style = function(e, t, n) {
				function s() {
					this.style.removeProperty(e)
				}
				var r = arguments.length;
				...
				var i = yt(e);
				return An(this, "style." + e, t, function(t) {
					function r() {
						var r = getComputedStyle(this, null).getPropertyValue(e),
							s;
						return r !== t && (s = i(r, t), function(t) {
							this.style.setProperty(e, s(t), n)
						})
					}
					return t == null ? s : (t += "", r)
				})
			}, xn.styleTween = function(e, t, n) {
				return arguments.length < 3 && (n = ""), this.tween("style." + e, function(r, i) {
					var s = t.call(this, r, i, getComputedStyle(this, null).getPropertyValue(e));
					return s && function(t) {
						this.style.setProperty(e, s(t), n)
					}
				})
			}, xn.text = function(e) {
				return An(this, "text", e, Ln)
			}, xn.remove = function() {
				...
				var t = this.id;
				return arguments.length < 1 ? this.node().__transition__[t].ease : (typeof e != "function" && (e = d3.ease.apply(d3, arguments)), yn(this, function(n) {
					n.__transition__[t].ease = e
				}))
			}, xn.delay = function(e) {
				var t = this.id;
				return yn(this, typeof e == "function" ? function(n, r, i) {
					n.__transition__[t].delay = e.call(n, n.__data__, r, i) | 0
				} : (e |= 0, function(n) {
					n.__transition__[t].delay = e
				}))
			}, xn.duration = function(e) {
				var t = this.id;
				return yn(this, typeof e == "function" ? function(n, r, i) {
			...
			}, xn.each = function(e, t) {
				var n = this.id;
				if(arguments.length < 2) {
					var r = Cn,
						i = Nn;
					Nn = n, yn(this, function(t, r, i) {
						Cn = t.__transition__[n], e.call(t, t.__data__, r, i)
					}), Cn = r, Nn = i
				} else yn(this, function(r) {
					r.__transition__[n].event.on(e, t)
				});
				return this
			}, xn.transition = function() {
				var e = this.id,
					t = ++Tn,
					n = [],
					r, i, s, o;
				for(var u = 0, a = this.length; u < a; u++) {
					...
					for(var i = this[u], f = 0, l = i.length; f < l; f++) {
						if(s = i[f]) o = Object.create(s.__transition__[e]), o.delay += o.duration, kn(s, f, t, o);
						r.push(s)
					}
				}
				return Sn(n, t)
			}, xn.tween = function(e, t) {
				var n = this.id;
				return arguments.length < 2 ? this.node().__transition__[n].tween.get(e) : yn(this, t == null ? function(t) {
			...
			d3.timer = function(e, t, n) {
				...
				var r = Mn[e.id];
				r && r.callback === e ? (r.then = n, r.delay = t) : Mn[e.id = ++On] = _n = {
					callback: e,
					then: n,
					delay: t,
					next: _n
				}, Dn || (Pn = clearTimeout(Pn), Dn = 1, jn(Hn))
			...
			var jn = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
				setTimeout(e, 17)
			};
			d3.mouse = function(e) {
				return In(e, lt())
			...
			d3.touches = function(e, t) {
				return arguments.length < 2 && (t = lt().touches), t ? p(t).map(function(t) {
					var n = In(e, t);
					return n.identifier = t.identifier, n
				}) : []
			}, d3.scale = {}, d3.scale.linear = function() {
				return Xn([0, 1], [0, 1], d3.interpolate, !1)
			}, d3.scale.log = function() {
				return Zn(d3.scale.linear(), tr)
			};
			var er = d3.format(".0e");
			tr.pow = function(e) {
				...
				return d3.scale.ordinal().range(or)
			}, d3.scale.category20 = function() {
				return d3.scale.ordinal().range(ur)
			}, d3.scale.category20b = function() {
				return d3.scale.ordinal().range(ar)
			}, d3.scale.category20c = function() {
				return d3.scale.ordinal().range(fr)
			};
			var or = ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf"],
				ur = ["#1f77b4", "#aec7e8", "#ff7f0e", "#ffbb78", "#2ca02c", "#98df8a", "#d62728", "#ff9896", "#9467bd", "#c5b0d5", "#8c564b", "#c49c94", "#e377c2", "#f7b6d2", "#7f7f7f", "#c7c7c7", "#bcbd22", "#dbdb8d", "#17becf", "#9edae5"],
				ar = ["#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6"],
				fr = ["#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9"];
			d3.scale.quantile = function() {
				...
				function i() {
					var i = e.apply(this, arguments),
						...
						u = n.apply(this, arguments) + dr,
						a = r.apply(this, arguments) + dr,
						f = (a < u && (f = u, u = a, a = f), a - u),
						l = f < o ? "0" : "1",
						c = Math.cos(u),
						h = Math.sin(u),
						p = Math.cos(a),
						d = Math.sin(a);
					return f >= vr ? i ? "M0," + s + "A" + s + "," + s + " 0 1,1 0," + -s + "A" + s + "," + s + " 0 1,1 0," + s + "M0," + i + "A" + i + "," + i + " 0 1,0 0," + -i + "A" + i + "," + i + " 0 1,0 0," + i + "Z" : "M0," + s + "A" + s + "," + s + " 0 1,1 0," + -s + "A" + s + "," + s + " 0 1,1 0," + s + "Z" : i ? "M" + s * c + "," + s * h + "A" + s + "," + s + " 0 " + l + ",1 " + s * p + "," + s * d + "L" + i * p + "," + i * d + "A" + i + "," + i + " 0 " + l + ",0 " + i * c + "," + i * h + "Z" : "M" + s * c + "," + s * h + "A" + s + "," + s + " 0 " + l + ",1 " + s * p + "," + s * d + "L0,0" + "Z"
				}
				var e = mr,
					t = gr,
					n = yr,
				...
				return i.innerRadius = function(t) {
					return arguments.length ? (e = x(t), i) : e
				}, i.outerRadius = function(e) {
					return arguments.length ? (t = x(e), i) : t
				}, i.startAngle = function(e) {
					return arguments.length ? (n = x(e), i) : n
				}, i.endAngle = function(e) {
					return arguments.length ? (r = x(e), i) : r
				}, i.centroid = function() {
					var i = (e.apply(this, arguments) + t.apply(this, arguments)) / 2,
						s = (n.apply(this, arguments) + r.apply(this, arguments)) / 2 + dr;
			...
			d3.svg.line.radial = function() {
			...
			}, Cr.reverse = kr, kr.reverse = Cr, d3.svg.area = function() {
				return $r(E)
				...
				function s(n, r) {
					var i = u(this, e, n, r),
						s = u(this, t, n, r);
					return "M" + i.p0 + f(i.r, i.p1, i.a1 - i.a0) + (a(i, s) ? h(i.r, i.p1, i.r, i.p0) : h(i.r, i.p1, s.r, s.p0) + f(s.r, s.p1, s.a1 - s.a0) + h(s.r, s.p1, i.r, i.p0)) + "Z"
				}
				...
				return s.radius = function(e) {
					return arguments.length ? (n = x(e), s) : n
				}, s.source = function(t) {
					return arguments.length ? (e = x(t), s) : e
				}, s.target = function(e) {
					return arguments.length ? (t = x(e), s) : t
				}, s.startAngle = function(e) {
					return arguments.length ? (r = x(e), s) : r
				}, s.endAngle = function(e) {
					return arguments.length ? (i = x(e), s) : i
				}, s
				...
				return r.source = function(t) {
					return arguments.length ? (e = x(t), r) : e
				}, r.target = function(e) {
					return arguments.length ? (t = x(e), r) : t
				...
				return e.projection = function(e) {
					return arguments.length ? n(Qr(t = e)) : t
				}, e
			}, d3.svg.symbol = function() {
				function n(n, r) {
					return(ei.get(e.call(this, n, r)) || Zr)(t.call(this, n, r))
				}
				var e = Yr,
					t = Gr;
				return n.type = function(t) {
					return arguments.length ? (e = x(t), n) : e
				}, n.size = function(e) {
					return arguments.length ? (t = x(e), n) : t
				}, n
			};
			var ei = d3.map({
				circle: Zr,
			...
			d3.svg.axis = function() {
				function l(l) {
					l.each(function() {
						var l = d3.select(this),
							c = u == null ? e.ticks ? e.ticks.apply(e, o) : e.domain() : u,
							h = a == null ? e.tickFormat ? e.tickFormat.apply(e, o) : String : a,
							p = si(e, c, f),
							d = l.selectAll(".minor").data(p, String),
							...
							S, x = Un(e),
							T = l.selectAll(".domain").data([0]),
							N = d3.transition(T),
							C = e.copy(),
							k = this.__chart__ || C;
						this.__chart__ = C, T.enter().append("path").attr("class", "domain"), b.append("line").attr("class", "tick"), b.append("text");
						var L = b.select("line"),
							A = E.select("line"),
							O = y.select("text").text(h),
							M = b.select("text"),
							_ = E.select("text");
						switch(t) {
							case "bottom":
								S = ri, v.attr("y2", r), g.attr("x2", 0).attr("y2", r), L.attr("y2", n), M.attr("y", Math.max(n, 0) + s), A.attr("x2", 0).attr("y2", n), _.attr("x", 0).attr("y", Math.max(n, 0) + s), O.attr("dy", ".71em").style("text-anchor", "middle"), N.attr("d", "M" + x[0] + "," + i + "V0H" + x[1] + "V" + i);
								break;
							case "top":
								S = ri, v.attr("y2", -r), g.attr("x2", 0).attr("y2", -r), L.attr("y2", -n), M.attr("y", -(Math.max(n, 0) + s)), A.attr("x2", 0).attr("y2", -n), _.attr("x", 0).attr("y", -(Math.max(n, 0) + s)), O.attr("dy", "0em").style("text-anchor", "middle"), N.attr("d", "M" + x[0] + "," + -i + "V0H" + x[1] + "V" + -i);
								break;
							case "left":
								S = ii, v.attr("x2", -r), g.attr("x2", -r).attr("y2", 0), L.attr("x2", -n), M.attr("x", -(Math.max(n, 0) + s)), A.attr("x2", -n).attr("y2", 0), _.attr("x", -(Math.max(n, 0) + s)).attr("y", 0), O.attr("dy", ".32em").style("text-anchor", "end"), N.attr("d", "M" + -i + "," + x[0] + "H0V" + x[1] + "H" + -i);
								break;
							case "right":
								S = ii, v.attr("x2", r), g.attr("x2", r).attr("y2", 0), L.attr("x2", n), M.attr("x", Math.max(n, 0) + s), A.attr("x2", n).attr("y2", 0), _.attr("x", Math.max(n, 0) + s).attr("y", 0), O.attr("dy", ".32em").style("text-anchor", "start"), N.attr("d", "M" + i + "," + x[0] + "H0V" + x[1] + "H" + i)
						}
						if(e.ticks) b.call(S, k), E.call(S, C), w.call(S, C), v.call(S, k), g.call(S, C), m.call(S, C);
						else {
							var D = C.rangeBand() / 2,
								P = function(e) {
									return C(e) + D
								};
							b.call(S, P), E.call(S, P)
						}
					})
				}
				...
				function o(e) {
					e.each(function() {
						var e = d3.select(this),
							i = e.selectAll(".background").data([0]),
							s = e.selectAll(".extent").data([0]),
							c = e.selectAll(".resize").data(r, String),
							h;
						e.style("pointer-events", "all").on("mousedown.brush", l).on("touchstart.brush", l), i.enter().append("rect").attr("class", "background").style("visibility", "hidden").style("cursor", "crosshair"), s.enter().append("rect").attr("class", "extent").style("cursor", "move"), c.enter().append("g").attr("class", function(e) {
							return "resize " + e
						...
						}).attr("width", 6).attr("height", 6).style("visibility", "hidden"), c.style("display", o.empty() ? "none" : null), c.exit().remove(), t && (h = Un(t), i.attr("x", h[0]).attr("width", h[1] - h[0]), a(e)), n && (h = Un(n), i.attr("y", h[0]).attr("height", h[1] - h[0]), f(e)), u(e)
					})
				}

				function u(e) {
					e.selectAll(".resize").attr("transform", function(e) {
						return "translate(" + i[+/e$/.test(e)][0] + "," + i[+/^s/.test(e)][1] + ")"
					})
				}

				function a(e) {
					e.select(".extent").attr("x", i[0][0]), e.selectAll(".extent,.n>rect,.s>rect").attr("width", i[1][0] - i[0][0])
				}

				function f(e) {
					e.select(".extent").attr("y", i[0][1]), e.selectAll(".extent,.e>rect,.w>rect").attr("height", i[1][1] - i[0][1])
				}

				function l() {
					function x() {
						var e = d3.event.changedTouches;
						return e ? d3.touches(r, e)[0] : d3.mouse(r)
					}

					function T() {
						d3.event.keyCode == 32 && (m || (g = null, y[0] -= i[1][0], y[1] -= i[1][1], m = 2), ft())
					}

					function N() {
						d3.event.keyCode == 32 && m == 2 && (y[0] += i[1][0], y[1] += i[1][1], m = 0, ft())
					}

					function C() {
						var e = x(),
							r = !1;
						b && (e[0] += b[0], e[1] += b[1]), m || (d3.event.altKey ? (g || (g = [(i[0][0] + i[1][0]) / 2, (i[0][1] + i[1][1]) / 2]), y[0] = i[+(e[0] < g[0])][0], y[1] = i[+(e[1] < g[1])][1]) : g = null), d && k(e, t, 0) && (a(h), r = !0), v && k(e, n, 1) && (f(h), r = !0), r && (u(h), c({
							type: "brush",
							mode: m ? "move" : "resize"
						}))
					}
					...
					function k(e, t, n) {
						var r = Un(t),
							...
							f = i[1][n] - i[0][n],
							l, c;
						m && (o -= a, u -= f + a), l = Math.max(o, Math.min(u, e[n])), m ? c = (l += a) + f : (g && (a = Math.max(o, Math.min(u, 2 * g[n] - l))), a < l ? (c = l, l = a) : c = a);
						if(i[0][n] !== l || i[1][n] !== c) return s = null, i[0][n] = l, i[1][n] = c, !0
					}

					function L() {
						C(), h.style("pointer-events", "all").selectAll(".resize").style("display", o.empty() ? "none" : null), d3.select("body").style("cursor", null), w.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), c({
							type: "brushend"
						}), ft()
					}
					var r = this,
						l = d3.select(d3.event.target),
						c = e.of(r, arguments),
						h = d3.select(r),
						p = l.datum(),
						d = !/^(n|s)$/.test(p) && t,
						...
						m = l.classed("extent"),
						g, y = x(),
						b, w = d3.select(window).on("mousemove.brush", C).on("mouseup.brush", L).on("touchmove.brush", C).on("touchend.brush", L).on("keydown.brush", T).on("keyup.brush", N);
					if(m) y[0] = i[0][0] - y[0], y[1] = i[0][1] - y[1];
					else if(p) {
						var E = +/w$/.test(p),
							S = +/^n/.test(p);
						b = [i[1 - E][0] - y[0], i[1 - S][1] - y[1]], y[0] = i[E][0], y[1] = i[S][1]
					} else d3.event.altKey && (g = y.slice());
					h.style("pointer-events", "none").selectAll(".resize").style("display", null), d3.select("body").style("cursor", l.style("cursor")), c({
						type: "brushstart"
					}), C(), ft()
				}
				var e = ct(o, "brushstart", "brush", "brushend"),
					t = null,
					n = null,
					r = ui[0],
					i = [
				...
				return o.x = function(e) {
					return arguments.length ? (t = e, r = ui[!t << 1 | !n], o) : t
				}, o.y = function(e) {
					return arguments.length ? (n = e, r = ui[!t << 1 | !n], o) : n
				}, o.extent = function(e) {
					var r, u, a, f, l;
					return arguments.length ? (s = [
						[0, 0],
						[0, 0]
					], t && (r = e[0], u = e[1], n && (r = r[0], u = u[0]), s[0][0] = r, s[1][0] = u, t.invert && (r = t(r), u = t(u)), u < r && (l = r, r = u, u = l), i[0][0] = r | 0, i[1][0] = u | 0), n && (a = e[0], f = e[1], t && (a = a[1], f = f[1]), s[0][1] = a, s[1][1] = f, n.invert && (a = n(a), f = n(f)), f < a && (l = a, a = f, f = l), i[0][1] = a | 0, i[1][1] = f | 0), o) : (e = s || i, t && (r = e[0][0], u = e[1][0], s || (r = i[0][0], u = i[1][0], t.invert && (r = t.invert(r), u = t.invert(u)), u < r && (l = r, r = u, u = l))), n && (a = e[0][1], f = e[1][1], s || (a = i[0][1], f = i[1][1], n.invert && (a = n.invert(a), f = n.invert(f)), f < a && (l = a, a = f, f = l))), t && n ? [
						[r, a],
						[u, f]
					] : t ? [r, u] : n && [a, f])
				}, o.clear = function() {
					return s = null, i[0][0] = i[0][1] = i[1][0] = i[1][1] = 0, o
				}, o.empty = function() {
					return t && i[0][0] === i[1][0] || n && i[0][1] === i[1][1]
				}, d3.rebind(o, e, "on")
			};
			var oi = {
					n: "ns-resize",
			...
			d3.behavior = {}, d3.behavior.drag = function() {
				function n() {
					this.on("mousedown.drag", r).on("touchstart.drag", r)
				}

				function r() {
					function l() {
						var e = n.parentNode;
						return s != null ? d3.touches(e).filter(function(e) {
							return e.identifier === s
						})[0] : d3.mouse(e)
					}

					function c() {
						if(!n.parentNode) return h();
						var e = l(),
							t = e[0] - u[0],
							i = e[1] - u[1];
						a |= t | i, u = e, ft(), r({
					...
					function h() {
						r({
							type: "dragend"
						}), a && (ft(), d3.event.target === i && f.on("click.drag", p, !0)), f.on(s != null ? "touchmove.drag-" + s : "mousemove.drag", null).on(s != null ? "touchend.drag-" + s : "mouseup.drag", null)
					}

					function p() {
						ft(), f.on("click.drag", null)
					}
					var n = this,
						r = e.of(n, arguments),
						i = d3.event.target,
						...
						o, u = l(),
						a = 0,
						f = d3.select(window).on(s != null ? "touchmove.drag-" + s : "mousemove.drag", c).on(s != null ? "touchend.drag-" + s : "mouseup.drag", h, !0);
					t ? (o = t.apply(n, arguments), o = [o.x - u[0], o.y - u[1]]) : o = [0, 0], s == null && ft(), r({
						type: "dragstart"
					})
				}
				var e = ct(n, "drag", "dragstart", "dragend"),
					t = null;
				return n.origin = function(e) {
					return arguments.length ? (t = e, n) : t
				}, d3.rebind(n, e, "on")
			}, d3.behavior.zoom = function() {
				function c() {
					this.on("mousedown.zoom", y).on("mousewheel.zoom", b).on("mousemove.zoom", w).on("DOMMouseScroll.zoom", b).on("dblclick.zoom", E).on("touchstart.zoom", S).on("touchmove.zoom", x).on("touchend.zoom", S)
				}
				...
				function d(e) {
					n = Math.max(i[0], Math.min(i[1], e))
				}

				function v(t, n) {
					n = p(n), e[0] += t[0] - n[0], e[1] += t[1] - n[1]
				}

				function m() {
					u && u.domain(o.range().map(function(t) {
						return(t - e[0]) / n
					}).map(o.invert)), f && f.domain(a.range().map(function(t) {
						return(t - e[1]) / n
					}).map(a.invert))
				}

				function g(t) {
					m(), d3.event.preventDefault(), t({
						type: "zoom",
						scale: n,
						translate: e
					})
				...
				function y() {
					function u() {
						r = 1, v(d3.mouse(e), o), g(t)
					}

					function a() {
						r && ft(), i.on("mousemove.zoom", null).on("mouseup.zoom", null), r && d3.event.target === n && i.on("click.zoom", f, !0)
					}

					function f() {
						ft(), i.on("click.zoom", null)
					}
					var e = this,
						t = s.of(e, arguments),
						n = d3.event.target,
						r = 0,
						i = d3.select(window).on("mousemove.zoom", u).on("mouseup.zoom", a),
						o = h(d3.mouse(e));
					window.focus(), ft()
				}

				function b() {
					t || (t = h(d3.mouse(this))), d(Math.pow(2, li() * .002) * n), v(d3.mouse(this), t), g(s.of(this, arguments))
				}
				...
				function E() {
					var e = d3.mouse(this),
						t = h(e),
						r = Math.log(n) / Math.LN2;
					d(Math.pow(2, d3.event.shiftKey ? Math.ceil(r) - 1 : Math.floor(r) + 1)), v(e, t), g(s.of(this, arguments))
				}

				function S() {
					var e = d3.touches(this),
						i = Date.now();
					r = n, t = {}, e.forEach(function(e) {
						t[e.identifier] = h(e)
					}), ft();
					if(e.length === 1) {
						if(i - l < 500) {
							var o = e[0],
								u = h(e[0]);
							d(n * 2), v(o, u), g(s.of(this, arguments))
						}
						l = i
					}
				}
				...
				function x() {
					var e = d3.touches(this),
						...
						i = t[n.identifier];
					if(o = e[1]) {
						var o, u = t[o.identifier];
						n = [(n[0] + o[0]) / 2, (n[1] + o[1]) / 2], i = [(i[0] + u[0]) / 2, (i[1] + u[1]) / 2], d(d3.event.scale * r)
					}
					v(n, i), l = null, g(s.of(this, arguments))
				}
				var e = [0, 0],
					t, n = 1,
					r, i = fi,
					s = ct(c, "zoom"),
					o, u, a, f, l;
				return c.translate = function(t) {
					return arguments.length ? (e = t.map(Number), m(), c) : e
				}, c.scale = function(e) {
					return arguments.length ? (n = +e, m(), c) : n
				}, c.scaleExtent = function(e) {
					return arguments.length ? (i = e == null ? fi : e.map(Number), c) : i
				}, c.x = function(t) {
					return arguments.length ? (u = t, o = t.copy(), e = [0, 0], n = 1, c) : u
				}, c.y = function(t) {
					return arguments.length ? (f = t, a = t.copy(), e = [0, 0], n = 1, c) : f
				}, d3.rebind(c, s, "on")
			};
			var ai, fi = [0, Infinity];
			d3.layout = {}, d3.layout.bundle = function() {
				return function(e) {
					var t = [],
						n = -1,
						r = e.length;
					while(++n < r) t.push(ci(e[n]));
					return t
				}
				...
				function l() {
					...
					while(++g < i) {
						v = 0, y = -1;
						while(++y < i) v += r[g][y];
						l.push(v), p.push(d3.range(i)), d += v
					}
					...
					while(++g < i) {
						...
						while(++y < i) {
							var T = e[g + "-" + y],
								N = e[y + "-" + g];
							(T.value || N.value) && t.push(T.value < N.value ? {
								source: N,
								target: T
							} : {
								source: T,
				...
				var e = {},
					t, n, r, i, s = 0,
					u, a, f;
				return e.matrix = function(s) {
					return arguments.length ? (i = (r = s) && r.length, t = n = null, e) : r
				}, e.padding = function(r) {
					return arguments.length ? (s = r, t = n = null, e) : s
				}, e.sortGroups = function(r) {
					return arguments.length ? (u = r, t = n = null, e) : u
				}, e.sortSubgroups = function(n) {
					return arguments.length ? (a = n, t = null, e) : a
				}, e.sortChords = function(n) {
					return arguments.length ? (f = n, t && c(), e) : f
				}, e.chords = function() {
					return t || l(), t
				}, e.groups = function() {
					return n || l(), n
				...
				function g(t) {
					t.px = d3.event.x, t.py = d3.event.y, e.resume()
				}
				var e = {},
				...
				return e.tick = function() {
					...
					var e = c.length,
						...
						o, u, l, g, y, b, w, E, S;
					for(u = 0; u < r; ++u) {
						l = h[u], g = l.source, y = l.target, E = y.x - g.x, S = y.y - g.y;
						if(b = E * E + S * S) b = i * d[u] * ((b = Math.sqrt(b)) - p[u]) / b, E *= b, S *= b, y.x -= E * (w = g.weight / (y.weight + g.weight)), y.y -= S * w, g.x += E * (w = 1 - w), g.y += S * w
					}
					if(w = i * f) {
						E = n[0] / 2, S = n[1] / 2, u = -1;
						if(w)
							while(++u < e) l = c[u], l.x += (E - l.x) * w, l.y += (S - l.y) * w
					}
					if(a) {
						yi(o = d3.geom.quadtree(c), i, v), u = -1;
						while(++u < e)(l = c[u]).fixed || o.visit(m(l))
					}
					u = -1;
					while(++u < e) l = c[u], l.fixed ? (l.x = l.px, l.y = l.py) : (l.x -= (l.px - (l.px = l.x)) * s, l.y -= (l.py - (l.py = l.y)) * s);
					t.tick({
						type: "tick",
						alpha: i
					})
					...
					return arguments.length ? (o = x(t), e) : o
				}, e.distance = e.linkDistance, e.linkStrength = function(t) {
					return arguments.length ? (u = x(t), e) : u
				}, e.friction = function(t) {
					return arguments.length ? (s = t, e) : s
				}, e.charge = function(t) {
					return arguments.length ? (a = typeof t == "function" ? t : +t, e) : a
				}, e.gravity = function(t) {
					return arguments.length ? (f = t, e) : f
				}, e.theta = function(t) {
					return arguments.length ? (l = t, e) : l
				}, e.alpha = function(n) {
					return arguments.length ? (i ? n > 0 ? i = n : i = 0 : n > 0 && (t.start({
						type: "start",
						alpha: i = n
					}), d3.timer(e.tick)), e) : i
				}, e.start = function() {
					...
					function b() {
						if(!m) {
							...
							for(r = 0; r < s; ++r) {
								var e = h[r];
								m[e.source.index].push(e.target), m[e.target.index].push(e.source)
							}
						}
						return m[t]
					}
					var t, r, i = c.length,
						...
						l = n[1],
						m, g;
					for(t = 0; t < i; ++t)(g = c[t]).index = t, g.weight = 0;
					p = [], d = [];
					for(t = 0; t < s; ++t) g = h[t], typeof g.source == "number" && (g.source = c[g.source]), typeof g.target == "number" && (g.target = c[g.target]), p[t] = o.call(this, g, t), d[t] = u.call(this, g, t), ++g.source.weight, ++g.target.weight;
					for(t = 0; t < i; ++t) g = c[t], isNaN(g.x) && (g.x = y("x", f)), isNaN(g.y) && (g.y = y("y", l)), isNaN(g.px) && (g.px = g.x), isNaN(g.py) && (g.py = g.y);
					v = [];
					if(typeof a == "function")
						for(t = 0; t < i; ++t) v[t] = +a.call(this, c[t], t);
					else
						for(t = 0; t < i; ++t) v[t] = a;
					return e.resume()
				}, e.resume = function() {
					...
					r || (r = d3.behavior.drag().origin(E).on("dragstart", di).on("drag", g).on("dragend", vi)), this.on("mouseover.force", mi).on("mouseout.force", gi).call(r)
				}, d3.rebind(e, t, "on")
			}, d3.layout.partition = function() {
				function n(e, t, r, i) {
					var s = e.children;
					e.x = t, e.y = e.depth * i, e.dx = r, e.dy = i;
					if(s && (u = s.length)) {
						var o = -1,
							u, a, f;
						r = e.value ? r / e.value : 0;
						while(++o < u) n(a = s[o], t, f = a.value * r, i), t += f
					}
				}
				...
				function r(e) {
					...
					if(t && (s = t.length)) {
						var i = -1,
							s;
						while(++i < s) n = Math.max(n, r(t[i]))
					}
					return 1 + n
				}

				function i(i, s) {
					var o = e.call(this, i, s);
				...
				function i(s) {
					var o = s.map(function(t, n) {
							return +e.call(i, t, n)
						}),
						u = +(typeof n == "function" ? n.apply(this, arguments) : n),
						a = ((typeof r == "function" ? r.apply(this, arguments) : r) - n) / d3.sum(o),
						f = d3.range(s.length);
					t != null && f.sort(t === Ei ? function(e, t) {
						return o[t] - o[e]
					} : function(e, n) {
						return t(s[e], s[n])
					});
			...
			d3.layout.stack = function() {
				function o(u, a) {
					var f = u.map(function(t, n) {
							return e.call(o, t, n)
						}),
						l = f.map(function(e) {
							return e.map(function(e, t) {
								return [i.call(o, e, t), s.call(o, e, t)]
							})
						}),
						c = t.call(o, l, a);
					...
					var h = n.call(o, l, a),
						...
						v, m, g;
					for(m = 0; m < d; ++m) {
						r.call(o, f[0][m], g = h[m], l[0][m][1]);
						for(v = 1; v < p; ++v) r.call(o, f[v][m], g += l[v - 1][m][1], l[v][m][1])
					}
					return u
				}
				var e = E,
					...
					i = Si,
					s = xi;
				return o.values = function(t) {
					return arguments.length ? (e = t, o) : e
				}, o.order = function(e) {
					return arguments.length ? (t = typeof e == "function" ? e : Ni.get(e) || ki, o) : t
				}, o.offset = function(e) {
					return arguments.length ? (n = typeof e == "function" ? e : Ci.get(e) || Li, o) : n
				}, o.x = function(e) {
			...
			d3.layout.histogram = function() {
				function i(i, s) {
					...
					if(h > 0) {
						s = -1;
						while(++s < c) d = u[s], d >= a[0] && d <= a[1] && (l = o[d3.bisect(f, d, 1, h) - 1], l.y += p, l.push(i[s]))
					}
					return o
				}
				var e = !0,
				...
				return i.value = function(e) {
					...
					return arguments.length ? (r = typeof e == "number" ? function(t) {
						return Di(t, e)
					} : x(e), i) : r
				...
				function r(r, i) {
					...
					if(t > 0) {
						...
						os(o, function(e) {
							e.r += l
						}), os(o, Wi), os(o, function(e) {
							e.r -= l
						}), f = Math.max(2 * o.r / u, 2 * o.r / a)
					}
					return $i(o, u / 2, a / 2, 1 / f), s
				}
				var e = d3.layout.hierarchy().sort(qi),
					t = 0,
					n = [1, 1];
				return r.size = function(e) {
					return arguments.length ? (n = e, r) : n
				...
				function r(r, i) {
					...
					os(o, function(e) {
						var n = e.children;
						n && n.length ? (e.x = Qi(n), e.y = Ki(n)) : (e.x = u ? a += t(e, u) : 0, e.y = 0, u = e)
					});
					var f = Gi(o),
						l = Yi(o),
						c = f.x - t(f, l) / 2,
						h = l.x + t(l, f) / 2;
					return os(o, function(e) {
						e.x = (e.x - c) / (h - c) * n[0], e.y = (1 - (o.y ? e.y / o.y : 1)) * n[1]
					}), s
				}
				...
				function r(r, i) {
					function u(e, n) {
						...
						if(r && (s = r.length)) {
							...
							n ? (i.prelim = n._tree.prelim + t(e, n), i.mod = i.prelim - p) : i.prelim = p
						} else n && (i.prelim = n._tree.prelim + t(e, n))
					}
					...
					function f(e, n, r) {
						if(n) {
							var i = e,
								...
								c = u._tree.mod,
								h;
							while(o = ts(o), i = es(i), o && i) u = es(u), s = ts(s), s._tree.ancestor = e, h = o._tree.prelim + l - i._tree.prelim - a + t(o, i), h > 0 && (as(fs(o, e, r), e, h), a += h, f += h), l += o._tree.mod, a += i._tree.mod, c += u._tree.mod, f += s._tree.mod;
							o && !ts(s) && (s._tree.thread = o, s._tree.mod += l - f), i && !es(u) && (u._tree.thread = i, u._tree.mod += a - c, r = e)
						}
						return r
					}
					var s = e.call(this, r, i),
					...
					var l = ns(o, is),
						...
						v = h.depth || 1;
					return os(o, function(e) {
						e.x = (e.x - p) / (d - p) * n[0], e.y = e.depth / v * n[1], delete e._tree
					}), s
				}
				var e = d3.layout.hierarchy().sort(null).value(null),
					t = Zi,
				...
				function l(e) {
					...
					if(t && t.length) {
						var n = i(e),
							...
							s = t.slice(),
							o, a = Infinity,
							c, d = u === "slice" ? n.dx : u === "dice" ? n.dy : u === "slice-dice" ? e.depth & 1 ? n.dy : n.dx : Math.min(n.dx, n.dy),
							v;
						f(s, n.dx * n.dy / e.value), r.area = 0;
						while((v = s.length) > 0) r.push(o = s[v - 1]), r.area += o.area, u !== "squarify" || (c = h(r, d)) <= a ? (s.pop(), a = c) : (r.area -= r.pop().area, p(r, d, n, !1), d = Math.min(n.dx, n.dy), r.length = r.area = 0, a = Infinity);
						r.length && (p(r, d, n, !0), r.length = r.area = 0), t.forEach(l)
					}
				}
				...
				function c(e) {
					...
					if(t && t.length) {
						var n = i(e),
							r = t.slice(),
							s, o = [];
						f(r, n.dx * n.dy / e.value), o.area = 0;
						while(s = r.pop()) o.push(s), o.area += s.area, s.z != null && (p(o, s.z ? n.dx : n.dy, n, !r.length), o.length = o.area = 0);
						t.forEach(c)
					}
				}
				...
				function h(e, t) {
					...
					return n *= n, t *= t, n ? Math.max(t * i * a / n, n / (t * s * a)) : Infinity
				}
				...
				function p(e, n, r, i) {
					...
					if(n == r.dx) {
						if(i || f > r.dy) f = r.dy;
						while(++s < o) l = e[s], l.x = u, l.y = a, l.dy = f, u += l.dx = Math.min(r.x + r.dx - u, f ? t(l.area / f) : 0);
						l.z = !0, l.dx += r.x + r.dx - u, r.y += f, r.dy -= f
					} else {
						if(i || f > r.dx) f = r.dx;
						while(++s < o) l = e[s], l.x = u, l.y = a, l.dx = f, a += l.dy = Math.min(r.y + r.dy - a, f ? t(l.area / f) : 0);
				...
				function d(t) {
					var r = o || e(t),
						i = r[0];
					return i.x = 0, i.y = 0, i.dx = n[0], i.dy = n[1], o && e.revalue(i), f([i], i.dx * i.dy / i.value), (o ? c : l)(i), s && (o = r), r
				}
				var e = d3.layout.hierarchy(),
					t = Math.round,
					n = [1, 1],
				...
				return d.size = function(e) {
					...
					function t(t) {
						var n = e.call(d, t, t.depth);
						return n == null ? ls(t) : cs(t, typeof n == "number" ? [n, n, n, n] : n)
					}
					...
					var s;
					return i = (r = e) == null ? ls : (s = typeof e) === "function" ? t : s === "number" ? (e = [e, e, e, e], n) : n, d
				}, d.round = function(e) {
					return arguments.length ? (t = e ? Math.round : Number, d) : t != Number
				}, d.sticky = function(e) {
			...
			}, d3.csv = hs(",", "text/csv"), d3.tsv = hs("	", "text/tab-separated-values"), d3.geo = {}, d3.geo.stream = function(e, t) {
				ds.hasOwnProperty(e.type) ? ds[e.type](e, t) : ps(e, t)
			};
			var ds = {
				...
				vs = {
					...
					LineString: function(e, t) {
						ms(e.coordinates, t, 0)
					},
					MultiLineString: function(e, t) {
						var n = e.coordinates,
							r = -1,
							i = n.length;
						while(++r < i) ms(n[r], t, 0)
					},
			...
			d3.geo.albersUsa = function() {
				...
				function s(i) {
					var s = i[0],
						o = i[1];
					return o > 50 ? t : s < -140 ? n : o < 21 ? r : e
				}
				var e = d3.geo.albers(),
					t = d3.geo.albers().rotate([160, 0]).center([0, 60]).parallels([55, 65]),
					n = d3.geo.albers().rotate([160, 0]).center([0, 20]).parallels([8, 18]),
					r = d3.geo.albers().rotate([60, 0]).center([0, 10]).parallels([8, 18]);
				return i.scale = function(s) {
					return arguments.length ? (e.scale(s), t.scale(s * .6), n.scale(s), r.scale(s * 1.5), i.translate(e.translate())) : e.scale()
				}, i.translate = function(s) {
					if(!arguments.length) return e.translate();
					var o = e.scale(),
						u = s[0],
						a = s[1];
					return e.translate(s), t.translate([u - .4 * o, a + .17 * o]), n.translate([u - .19 * o, a + .2 * o]), r.translate([u + .58 * o, a + .43 * o]), i
				}, i.scale(e.scale())
				...
				return r.parallels = function(r) {
					return arguments.length ? n(e = r[0] * a, t = r[1] * a) : [e * f, t * f]
				}, r.rotate([98, 0]).center([0, 38]).scale(1e3)
			}).raw = ks;
			var Ls = Ho(function(e) {
			...
			(d3.geo.azimuthalEquidistant = function() {
				return ko(As)
			}).raw = As, d3.geo.bounds = Os(E), d3.geo.centroid = function(e) {
				Ms = _s = Ds = Ps = Hs = 0, d3.geo.stream(e, Bs);
				var t;
				if(_s && Math.abs(t = Math.sqrt(Ds * Ds + Ps * Ps + Hs * Hs)) > u) return [Math.atan2(Ps, Ds) * f, Math.asin(Math.max(-1, Math.min(1, Hs / t))) * f]
			};
			var Ms, _s, Ds, Ps, Hs, Bs = {
				sphere: function() {
					Ms < 2 && (Ms = 2, _s = Ds = Ps = Hs = 0)
				},
				point: js,
				lineStart: Is,
				lineEnd: qs,
				polygonStart: function() {
					Ms < 2 && (Ms = 2, _s = Ds = Ps = Hs = 0), Bs.lineStart = Fs
				},
				polygonEnd: function() {
					Bs.lineStart = Is
				}
			...
			d3.geo.circle = function() {
				function i() {
					var t = typeof e == "function" ? e.apply(this, arguments) : e,
						n = Oo(-t[0] * a, -t[1] * a, 0).invert,
						i = [];
					return r(null, null, 1, {
						point: function(e, t) {
							i.push(e = n(e, t)), e[0] *= f, e[1] *= f
						}
					}), {
						type: "Polygon",
						coordinates: [i]
				...
				return i.origin = function(t) {
					...
					return arguments.length ? (r = Rs((t = +e) * a, n * a), i) : t
				}, i.precision = function(e) {
					return arguments.length ? (r = Rs(t * a, (n = +e) * a), i) : n
				}, i.angle(90)
			};
			var Qs = zs(S, Gs, Zs);
			(d3.geo.equirectangular = function() {
				return ko(no).scale(250 / o)
			}).raw = no.invert = no;
			var ro = Ho(function(e) {
				return 1 / e
			}, Math.atan);
			(d3.geo.gnomonic = function() {
				return ko(ro)
			}).raw = ro, d3.geo.graticule = function() {
				function l() {
					return {
				...
				function c() {
					return d3.range(Math.ceil(t / i) * i, e, i).map(o).concat(d3.range(Math.ceil(r / s) * s, n, s).map(a))
				}
				var e, t, n, r, i = 22.5,
					s = i,
					o, a, f = 2.5;
				return l.lines = function() {
					...
					return {
						type: "Polygon",
						coordinates: [o(t).concat(a(n).slice(1), o(e).reverse().slice(1), a(r).reverse().slice(1))]
					}
				}, l.extent = function(i) {
					return arguments.length ? (t = +i[0][0], e = +i[1][0], r = +i[0][1], n = +i[1][1], t > e && (i = t, t = e, e = i), r > n && (i = r, r = n, n = i), l.precision(f)) : [
						[t, r],
						[e, n]
					]
				}, l.step = function(e) {
					return arguments.length ? (i = +e[0], s = +e[1], l) : [i, s]
				}, l.precision = function(i) {
					return arguments.length ? (f = +i, o = io(r, n, f), a = so(t, e, f), l) : f
				}, l.extent([
					[-180 + u, -90 + u],
					[180 - u, 90 - u]
				])
			}, d3.geo.interpolate = function(e, t) {
				return oo(e[0] * a, e[1] * a, t[0] * a, t[1] * a)
			}, d3.geo.greatArc = function() {
				function o() {
					var r = t || e.apply(this, arguments),
						o = a || n.apply(this, arguments),
						u = s || d3.geo.interpolate(r, o),
						a = 0,
						f = i / u.distance,
						l = [r];
					while((a += f) < 1) l.push(u(a));
					return l.push(o), {
						type: "LineString",
						coordinates: l
					}
				...
				return o.distance = function() {
					return(s || d3.geo.interpolate(t || e.apply(this, arguments), r || n.apply(this, arguments))).distance
				}, o.source = function(n) {
					return arguments.length ? (e = n, t = typeof n == "function" ? null : n, s = t && r ? d3.geo.interpolate(t, r) : null, o) : e
				}, o.target = function(e) {
					return arguments.length ? (n = e, r = typeof e == "function" ? null : e, s = t && r ? d3.geo.interpolate(t, r) : null, o) : n
				}, o.precision = function(e) {
					return arguments.length ? (i = e * a, o) : i / a
				}, o
			}, uo.invert = function(e, t) {
				return [2 * o * e, 2 * Math.atan(Math.exp(2 * o * t)) - o / 2]
			}, (d3.geo.mercator = function() {
				return ko(uo).scale(500)
			}).raw = uo;
			var ao = Ho(function() {
				return 1
			}, Math.asin);
			(d3.geo.orthographic = function() {
				return ko(ao)
			}).raw = ao, d3.geo.path = function() {
				function s(t) {
					return t && d3.geo.stream(t, r(i.pointRadius(typeof e == "function" ? +e.apply(this, arguments) : e))), i.result()
				}
				var e = 4.5,
					t, n, r, i;
				return s.area = function(e) {
					return po = 0, d3.geo.stream(e, r(mo)), po
				}, s.centroid = function(e) {
					return Ms = Ds = Ps = Hs = 0, d3.geo.stream(e, r(yo)), Hs ? [Ds / Hs, Ps / Hs] : undefined
				}, s.bounds = function(e) {
					return Os(r)(e)
				}, s.projection = function(e) {
					return arguments.length ? (r = (t = e) ? e.stream || lo(e) : E, s) : t
				}, s.context = function(e) {
					return arguments.length ? (i = (n = e) == null ? new co : new ho(e), s) : n
				}, s.pointRadius = function(t) {
					return arguments.length ? (e = typeof t == "function" ? t : +t, s) : e
				}, s.projection(d3.geo.albersUsa()).context(null)
			};
			var po, vo, mo = {
					point: qn,
					lineStart: qn,
					lineEnd: qn,
					polygonStart: function() {
						vo = 0, mo.lineStart = go
					},
					polygonEnd: function() {
						mo.lineStart = mo.lineEnd = mo.point = qn, po += Math.abs(vo / 2)
					}
				},
				yo = {
					point: bo,
					...
					polygonEnd: function() {
						yo.point = bo, yo.lineStart = wo, yo.lineEnd = Eo
					}
				};
			d3.geo.area = function(e) {
				return xo = 0, d3.geo.stream(e, No), xo
			};
			var xo, To, No = {
				sphere: function() {
					xo += 4 * o
				...
				lineEnd: qn,
				polygonStart: function() {
					To = 0, No.lineStart = Co
				},
				polygonEnd: function() {
					xo += To < 0 ? 4 * o + To : To, No.lineStart = No.lineEnd = No.point = qn
				}
			};
			d3.geo.projection = ko, d3.geo.projectionMutator = Lo;
			...
			(d3.geo.stereographic = function() {
				return ko(Po)
			}).raw = Po, d3.geom = {}, d3.geom.hull = function(e) {
				...
				for(; o < n; ++o) {
					...
					while(!Bo(i[v - 2], i[v - 1], r[o].index, e)) --v;
					i[v++] = r[o].index
				}
				var m = [];
				...
				return e.area = function() {
					...
					while(++r < i) {
						...
						while(++s < o) l = n[s], jo(l, u, a) ? (jo(f, u, a) || t.push(Fo(f, l, u, a)), t.push(l)) : jo(f, u, a) && t.push(Fo(f, l, u, a)), f = l;
						u = a
					}
					return t
				}, e
				...
				return qo(e, function(e) {
					var r, i, s, o, u, a;
					e.a === 1 && e.b >= 0 ? (r = e.ep.r, i = e.ep.l) : (r = e.ep.l, i = e.ep.r), e.a === 1 ? (u = r ? r.y : -n, s = e.c - e.b * u, a = i ? i.y : n, o = e.c - e.b * a) : (s = r ? r.x : -n, u = e.c - e.a * s, o = i ? i.x : n, a = e.c - e.a * o);
					var f = [s, u],
						l = [o, a];
					t[e.region.l.index].push(f, l), t[e.region.r.index].push(f, l)
				}), t = t.map(function(t, n) {
					var r = e[n][0],
						i = e[n][1],
						s = t.map(function(e) {
							return Math.atan2(e[0] - r, e[1] - i)
						});
					return d3.range(t.length).sort(function(e, t) {
						return s[e] - s[t]
					}).filter(function(e, t, n) {
						return !t || s[e] - s[n[t - 1]] > u
					}).map(function(e) {
						return t[e]
					})
				}), t.forEach(function(t, r) {
					var i = t.length;
					if(!i) return t.push([-n, -n], [-n, n], [n, n], [n, -n]);
					if(i > 2) return;
					var s = e[r],
						o = t[0],
						a = t[1],
					...
					if(Math.abs(m) < u) {
						...
						var g = (p - c) * (h - l) < (c - f) * (d - h) ? n : -n,
							b = Math.abs(m) - v;
						Math.abs(b) < u ? t.push([m < 0 ? g : -g, g]) : (b > 0 && (g *= -1), t.push([-n, g], [n, g]))
					}
				}), t
			};
			var Io = {
			...
			d3.geom.delaunay = function(e) {
				...
				function l(e, t, n, r, i, s) {
					...
					if(e.leaf) {
						var o = e.point;
						o ? Math.abs(o.x - t.x) + Math.abs(o.y - t.y) < .01 ? c(e, t, n, r, i, s) : (e.point = null, c(e, o, n, r, i, s), c(e, t, n, r, i, s)) : e.point = t
					} else c(e, t, n, r, i, s)
				}
				...
				function c(e, t, n, r, i, s) {
					var o = (n + i) * .5,
						...
						f = t.y >= u,
						c = (f << 1) + a;
					e.leaf = !1, e = e.nodes[c] || (e.nodes[c] = Ro()), a ? n = o : i = o, f ? r = u : s = u, l(e, t, n, r, i, s)
				}
				var s, o = -1,
					u = e.length;
				if(arguments.length < 5)
					if(arguments.length === 3) i = n, r = t, n = t = 0;
					else {
						t = n = Infinity, r = i = -Infinity;
						while(++o < u) s = e[o], s.x < t && (t = s.x), s.y < n && (n = s.y), s.x > r && (r = s.x), s.y > i && (i = s.y)
					}
				var a = r - t,
					f = i - n;
				a > f ? i = n + a : r = t + f;
			...
			var Vo = Date.prototype,
				...
				Jo = "%m/%d/%Y",
				Ko = "%H:%M:%S",
				Qo = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
				Go = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
				Yo = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
				...
				function n(n) {
					...
					while(++i < t)
						if(e.charCodeAt(i) === 37) {
							r.push(e.substring(s, i)), (u = lu[o = e.charAt(++i)]) != null && (o = e.charAt(++i));
							if(a = cu[o]) o = a(n, u == null ? o === "e" ? " " : "0" : u);
							r.push(o), s = i + 1
						}
			...
			var iu = tu(Qo),
				...
				cu = {
					...
					b: function(e) {
						return Zo[e.getMonth()]
					},
					B: function(e) {
						return Yo[e.getMonth()]
					},
					c: d3.time.format($o),
					d: function(e, t) {
						return ru(e.getDate(), t, 2)
					},
					e: function(e, t) {
						return ru(e.getDate(), t, 2)
					},
					H: function(e, t) {
						return ru(e.getHours(), t, 2)
					},
					I: function(e, t) {
						return ru(e.getHours() % 12 || 12, t, 2)
					},
					j: function(e, t) {
						return ru(1 + d3.time.dayOfYear(e), t, 3)
					},
					L: function(e, t) {
						return ru(e.getMilliseconds(), t, 3)
					},
					m: function(e, t) {
						return ru(e.getMonth() + 1, t, 2)
					},
					M: function(e, t) {
						return ru(e.getMinutes(), t, 2)
					},
					p: function(e) {
						return e.getHours() >= 12 ? "PM" : "AM"
					},
					S: function(e, t) {
						return ru(e.getSeconds(), t, 2)
					},
					U: function(e, t) {
						return ru(d3.time.sundayOfYear(e), t, 2)
					},
					w: function(e) {
						return e.getDay()
					},
					W: function(e, t) {
						return ru(d3.time.mondayOfYear(e), t, 2)
					},
					x: d3.time.format(Jo),
					X: d3.time.format(Ko),
					y: function(e, t) {
						return ru(e.getFullYear() % 100, t, 2)
					},
					Y: function(e, t) {
						return ru(e.getFullYear() % 1e4, t, 4)
					},
					Z: _u,
					"%": function() {
						return "%"
			...
			var Du = d3.time.format.utc("%Y-%m-%dT%H:%M:%S.%LZ");
			d3.time.format.iso = Date.prototype.toISOString ? Pu : Du, Pu.parse = function(e) {
				var t = new Date(e);
				return isNaN(t) ? null : t
			}, Pu.toString = Du.toString, d3.time.second = Hu(function(e) {
				return new zo(Math.floor(e / 1e3) * 1e3)
			}, function(e, t) {
				e.setTime(e.getTime() + Math.floor(t) * 1e3)
			}, function(e) {
				return e.getSeconds()
			}), d3.time.seconds = d3.time.second.range, d3.time.seconds.utc = d3.time.second.utc.range, d3.time.minute = Hu(function(e) {
				return new zo(Math.floor(e / 6e4) * 6e4)
			}, function(e, t) {
				e.setTime(e.getTime() + Math.floor(t) * 6e4)
			}, function(e) {
				return e.getMinutes()
			}), d3.time.minutes = d3.time.minute.range, d3.time.minutes.utc = d3.time.minute.utc.range, d3.time.hour = Hu(function(e) {
				var t = e.getTimezoneOffset() / 60;
				return new zo((Math.floor(e / 36e5 - t) + t) * 36e5)
			}, function(e, t) {
				e.setTime(e.getTime() + Math.floor(t) * 36e5)
			}, function(e) {
				return e.getHours()
			}), d3.time.hours = d3.time.hour.range, d3.time.hours.utc = d3.time.hour.utc.range, d3.time.day = Hu(function(e) {
				var t = new zo(1970, 0);
			...
			}), d3.time.week = d3.time.sunday, d3.time.weeks = d3.time.sunday.range, d3.time.weeks.utc = d3.time.sunday.utc.range, d3.time.weekOfYear = d3.time.sundayOfYear, d3.time.month = Hu(function(e) {
				return e = d3.time.day(e), e.setDate(1), e
			}, function(e, t) {
				e.setMonth(e.getMonth() + t)
			}, function(e) {
				return e.getMonth()
			}), d3.time.months = d3.time.month.range, d3.time.months.utc = d3.time.month.utc.range, d3.time.year = Hu(function(e) {
			...
			var zu = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6],
				Wu = [
					[d3.time.second, 1],
					[d3.time.second, 5],
					[d3.time.second, 15],
				...
				Vu = d3.scale.linear(),
				$u = qu(Xu);
			Wu.year = function(e, t) {
				return Vu.domain(e.map(Uu)).ticks(t).map(Ru)
			}, d3.time.scale = function() {
				return ju(d3.scale.linear(), Wu, $u)
			};
			var Ju = Wu.map(function(e) {
					return [e[0].utc, e[1]]
				}),
				Ku = [
					[d3.time.format.utc("%Y"), S],
				...
				Qu = qu(Ku);
			Ju.year = function(e, t) {
				return Vu.domain(e.map(Yu)).ticks(t).map(Gu)
			}, d3.time.scale.utc = function() {
				return ju(d3.scale.linear(), Ju, Qu)
			}
			...
			e("<style/>").html(["path {stroke: #FFFFFF; stroke-width: 1px;}", '.hoverover {font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; }', ".hoverinfo {padding: 4px; border-radius: 1px; background-color: #FFF; box-shadow: 1px 1px 5px #CCC; font-size: 12px; border: 1px solid #CCC; }", ".hoverinfo hr {border:1px dotted #CCC; }"].join("\n")).prependTo("head")
			...
			var i = e.View.extend({
				initialize: function(n) {
					...
					t.isUndefined(r.geo[this.options.projection]) && (this.options.projection = "albersUsa"), this.options.scope === "usa" ? this._map.set("pathData", t.reject(i.features, function(e) {
						return e.properties.continent !== "USA"
					})) : this._map.set("pathData", t.reject(i.features, function(e) {
						return e.properties.continent === "USA"
					})), this.options.geography_config = t.defaults(this.options.geography_config || {}, this.options._geography_config), this.options.bubble_config = t.defaults(this.options.bubble_config || {}, this.options._bubble_config)
				},
				...
				render: function() {
					...
					this.$el.append(o), this.setElement(o), i = this.$el.width(), s = this.$el.height();
					var u, a, f = this.options.scope.toLowerCase();
					switch(f) {
						case "world":
							u = r.geo.equirectangular().scale(i / 6.5);
							break;
						case "usa":
							u = r.geo.albersUsa().scale(i);
							break;
						case "southamerica":
							u = r.geo.equirectangular().scale(i * 1.1).center([-60.117187, -20.96144]);
							break;
						case "africa":
							u = r.geo.equirectangular().scale(i * .75).center([17.547656, 2.740675]);
							break;
						case "europe":
							u = r.geo.mercator().scale(2e3).center([15.996094, 54.95122]);
							break;
						case "southeastasia":
							u = r.geo.equirectangular().scale(i * .8).center([122.039063, 5.35156]);
							break;
						case "middleeast":
							u = r.geo.equirectangular().scale(i * .9).center([54.140625, 31.653381]);
							break;
						case "asia":
							u = r.geo.equirectangular().scale(i * .45).center([88.375, 40.930432]);
							break;
						case "australia":
							u = r.geo.equirectangular().scale(i * .45).center([134.824219, -25.799891]);
							break;
						default:
							u = r.geo.equirectangular()
					}
					u = u.translate([i / 2, s / 2]), a = this.path = r.geo.path().projection(u), this.projection = u, this._map.set("projection", u), this._map.set("path", a);
					var l = this.svg = r.select(this.el).append("svg:svg").attr("width", i).attr("height", s),
						c = l.append("svg:g").attr("id", "states"),
						h = c.selectAll("path").data(this._map.get("pathData")).enter(),
						p = h.append("path").attr("d", a).attr("data-type", "country").style("stroke", e.options.geography_config.borderColor).style("stroke-width", e.options.geography_config.borderWidth).style("fill", function(t) {
							var n = e.getFillColor(e.options.data[t.id]);
							return r.select(this).attr("data-fill", n), n
						});
					(this.options.geography_config.popupOnHover || this.options.bubble_config.popupOnHover) && n('<div class="hoverover" style="z-index: 1001;"/>').appendTo(this.$el), this.options.geography_config.popupOnHover && (p.on("mouseover", function(t) {
