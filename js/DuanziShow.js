        ...
        success: function (result) {
            ...
            $.each(news,function(index, value){
                $('.row').append(
                    ...
                    '<div class="panel-title">' + '<a href="view_duanzi.aspx?did=' + value['Did'] + '">' +
                    value['Dtitle'] + '</a>' +
                    ...
                    '<a href="view_duanzi.aspx?did=' + value['Did'] + '">' + '<img src="' + value['Dimage_url'] + '" alt="图片" width = "180px" height="120px">' + '</a>' +
                    '</div>' +
                    '<div class="content-right">' +
                    '<a href="view_News.aspx?Nid=' + value['Did'] + '">' +
                    value['Dcontent'] +
                    '</a>' +
                    '</div>' +
                    '</div>' +
...
function likeClick(){
    $(document).on("click", ".likeBox", function(){
        var did = jQuery(this).parent().parent().parent().parent().parent().attr('did');
