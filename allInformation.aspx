<%@ Page Language="C#" AutoEventWireup="true" CodeFile="allInformation.aspx.cs" Inherits="allInformation" %>
...
南极大陆为通常所说的南大洋（太平洋、印度洋和大西洋的南部水域）所包围，它与南美洲最近的距离为965公里，距新西兰2000公里、距澳大利亚2500公里、距南非3800公里、距中国北京的距离约有12000公里。南极大陆的总面积为1390万平方公里...
                        ...
                        <div class="InformationItemOutside">
                            <div class="InformationItemInside">
                                ...
                                <div class="itemRight">
                                    <%
                                        News_Load(Label1_News_Title, Label1_News_Content, Label1_News_Tag1, Label1_News_Tag2);
                                    %>
                                    <div class="informationTitle">
                        ...
                        <div class="InformationItemOutside">
                            <div class="InformationItemInside">
                                ...
                                <%
                                    News_Load(Label2_News_Title, Label2_News_Content, Label2_News_Tag1, Label2_News_Tag2);
                                %>
                                <div class="itemRight">
                                    <div class="informationTitle">
                                        <%--<a class="ahover">资讯标题</a>--%>
