<%@ Page Language="C#" AutoEventWireup="true" CodeFile="food_index.aspx.cs" Inherits="index" %>
        ...
        <div id="page-wrapper">
			<div class="main-page">
				...
				<div class="classification">
					<ul id ="typeUl">
						<li><i></i><a class="classification_type" href="#"><b>美食分类</b></a></li>
						<li><i></i><a class="classification_type" href="#"><b>美食分类</b></a></li>
						<li><i></i><a class="classification_type" href="#"><b>美食分类</b></a></li>
						<li><i></i><a class="classification_type" href="#"><b>美食分类</b></a></li>
						<li><i></i><a class="classification_type" href="#"><b>美食分类</b></a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-widget">
                                <div class="panel-title"><a href="view.aspx?Nid=1">春暖花开面朝大海 凯德来了带你去海边玩个痛快</a><ul class="panel-tools">
                                ...
                                <div class="panel-body" style="display: block;">
                                    ...
                                    <div class="candlestick">
                                        <div id="example-8">
                                            <!--<span>资讯内容</span>-->
                                            <div class="content-left"><a href="view.aspx?Nid=1">
                                                <img src="img/Information/1.jpg" alt="图片" width="180px" height="120px"></a></div>
                                            <div class="content-right"><a href="view.aspx?Nid=1">提起泰国的海岛，相信许多人都会想到“热闹”的普吉岛和苏梅岛，在靠近泰国柬埔寨边境，还有一座原生态美丽的岛屿象岛（Koh Chang）。虽然没有其他岛屿的知名度高，不过这里拥有属于自己的特色。象岛属于桐艾府（哒叻府），岛上</a></div>
                                        </div>
                                        <div class="sort">娱乐</div>
				...
				<div class="nav-right-two">
					<ul>
					    ...
					    <li><i class="fa fa-street-view" style="color: #8DB6CD;"></i><a class="nav-right-two_a_after" href="announceview.aspx"> 我要爆料</a></li>
					</ul>
				</div>
				<!--//row-->
			</div>
